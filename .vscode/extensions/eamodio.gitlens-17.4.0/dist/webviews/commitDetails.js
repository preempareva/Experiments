...
`;var rR=Object.defineProperty,rT=Object.getOwnPropertyDescriptor,rO=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?rT(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&rR(t,o,a),a};let rI=class extends lit_element_i{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return tw`<div class="progress-bar"></div>`}};rI.styles=eK`
		* {
			box-sizing: border-box;
		}
...
[${rU()}] ${this.altLabel}`:this.label}get effectiveLabel(){if(this.label||this.altLabel)return this.altLabel&&this.isAltKeyPressed?this.altLabel:this.label}get effectiveHref(){return this.isAltKeyPressed&&this.altHref?this.altHref:this.href}connectedCallback(){super.connectedCallback?.(),window.addEventListener("keydown",this),window.addEventListener("keyup",this)}disconnectedCallback(){super.disconnectedCallback?.(),window.removeEventListener("keydown",this),window.removeEventListener("keyup",this)}handleEvent(e){let t="Alt"===e.key||e.altKey;"keydown"===e.type?this.isAltKeyPressed=t:"keyup"===e.type&&t&&(this.isAltKeyPressed=!1)}render(){return tw`
	...
	`,rq([tI()],rV.prototype,"href",2),rq([tI({attribute:"alt-href"})],rV.prototype,"altHref",2),rq([tI()],rV.prototype,"label",2),rq([tI({attribute:"alt-label"})],rV.prototype,"altLabel",2),rq([tI()],rV.prototype,"icon",2),rq([tI({attribute:"alt-icon"})],rV.prototype,"altIcon",2),rq([tI({type:Boolean})],rV.prototype,"disabled",2),rq([tM("a")],rV.prototype,"defaultFocusEl",2),rq([tD()],rV.prototype,"isAltKeyPressed",2),rV=rq([tT("action-item")],rV);var rW=Object.defineProperty,rG=Object.getOwnPropertyDescriptor,rK=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?rG(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&rW(t,o,a),a};let rZ=class extends lit_element_i{firstUpdated(){this.role="navigation"}disconnectedCallback(){this._slotSubscriptionsDisposer?.(),super.disconnectedCallback?.()}render(){return tw`<slot @slotchange=${this.handleSlotChange}></slot>`}handleSlotChange(e){if(this._slotSubscriptionsDisposer?.(),this.actionNodes.length<2)return;let t=this.handleKeydown.bind(this),o=`${this.actionNodes.length}`,r=this.actionNodes.map((e,r)=>(e.setAttribute("aria-posinset",`${r+1}`),e.setAttribute("aria-setsize",o),e.setAttribute("tabindex",0===r?"0":"-1"),e.addEventListener("keydown",t,!1),{dispose:()=>{e?.removeEventListener("keydown",t,!1)}}));this._slotSubscriptionsDisposer=()=>{r?.forEach(({dispose:e})=>e())}}handleKeydown(e){if(!e.target||null==this.actionNodes||this.actionNodes.length<2)return;let t=e.target,o=parseInt(t.getAttribute("aria-posinset")??"0",10),r=null;if("ArrowLeft"===e.key){let e=1===o?this.actionNodes.length-1:o-2;r=this.actionNodes[e]}else if("ArrowRight"===e.key){let e=o===this.actionNodes.length?0:o;r=this.actionNodes[e]}null!=r&&r!==t&&(t.setAttribute("tabindex","-1"),r.setAttribute("tabindex","0"),r.focus())}};rZ.styles=eK`
		:host {
			display: flex;
			align-items: center;
			user-select: none;
		}
	`,rK([tz({flatten:!0})],rZ.prototype,"actionNodes",2),rZ=rK([tT("action-nav")],rZ);let rY=new WeakMap;function rX(e,t){return function(o,r,n){let a=rY.get(o.constructor);null==a&&rY.set(o.constructor,a=[]),a.push({method:n.value,keys:Array.isArray(e)?e:[e],afterFirstUpdate:t?.afterFirstUpdate??!1})}}let GlElement=class GlElement extends lit_element_i{emit(e,t,o){let r=new CustomEvent(e,{bubbles:!0,cancelable:!1,composed:!0,...o,detail:t});return this.dispatchEvent(r),r}update(e){let t=rY.get(this.constructor);if(null!=t)for(let{keys:o,method:r,afterFirstUpdate:n}of t){if(n&&!this.hasUpdated)continue;let t=o.filter(t=>e.has(t));t.length&&r.call(this,t)}super.update(e)}};let rQ={".":"Unchanged","!":"Ignored","?":"Untracked",A:"Added",D:"Deleted",M:"Modified",R:"Renamed",C:"Copied",AA:"Conflict",AU:"Conflict",UA:"Conflict",DD:"Conflict",DU:"Conflict",UD:"Conflict",UU:"Conflict",T:"Modified",U:"Updated but Unmerged"};var rJ=Object.defineProperty,r0=Object.getOwnPropertyDescriptor,r1=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?r0(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&rJ(t,o,a),a};let r2=class extends lit_element_i{get statusName(){return this.status?rQ[this.status]??"Unknown":""}updated(e){super.updated(e),e.has("status")&&(this.statusName?this.setAttribute("title",this.statusName):this.removeAttribute("title"))}renderIgnored(){return tw`
	...
	`,ns([tD()],na.prototype,"treeItems",2),ns([tI({reflect:!0})],na.prototype,"guides",2),ns([tI({type:Array,attribute:!1})],na.prototype,"model",1),na=ns([tT("gl-tree-generator")],na);var nl=Object.defineProperty,nc=Object.getOwnPropertyDescriptor,nd=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?nc(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&nl(t,o,a),a};let GlDetailsBase=class GlDetailsBase extends lit_element_i{constructor(){super(...arguments),this.tab="commit",this.isUncommitted=!1,this.emptyText="No Files"}get fileLayout(){return this.preferences?.files?.layout??"auto"}get isCompact(){return this.preferences?.files?.compact??!0}get indentGuides(){return this.preferences?.indentGuides??"none"}get filesChangedPaneLabel(){let e=this.files?.length??0,t=e>0?V("file",e):"Files";return`${t} changed`}renderChangedFiles(e,t){let o=this.files?.length??0,r=this.isTree(o),n="tree",a="list-tree",c="View as Tree";switch(this.fileLayout){case"auto":n="list",a="gl-list-auto",c="View as List";break;case"list":n="tree",a="list-flat",c="View as Tree";break;case"tree":n="auto",a="list-tree",c="View as Auto"}let d=this.createTreeModel(e,this.files??[],r,this.isCompact);return tw`
...
`;ra.define("sl-popup");var nb=Object.defineProperty,nv=Object.getOwnPropertyDescriptor,ny=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?nv(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&nb(t,o,a),a};let nw=class extends GlElement{constructor(){super(),this.placement="bottom",this.disabled=!1,this.distance=8,this.open=!1,this.arrow=!0,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleTriggerBlur=e=>{this.open&&this.hasTrigger("focus")&&(e.relatedTarget&&this.contains(e.relatedTarget)||this.hide())},this.handleTriggerClick=e=>{if(this.hasTrigger("click"))if(this.open&&"hover"!==this._triggeredBy){if(this._skipHideOnClick){this._skipHideOnClick=!1;return}if(e.composedPath().includes(this.body))return;this.hide()}else this.show("click")},this._skipHideOnClick=!1,this.handleTriggerMouseDown=()=>{this.hasTrigger("click")&&this.hasTrigger("focus")&&!this.matches(":focus-within")?this._skipHideOnClick=!0:this._skipHideOnClick=!1},this.handleTriggerFocus=()=>{this.hasTrigger("focus")&&(this.open&&"hover"!==this._triggeredBy&&!this.hasPopupFocus()?this.hide():this.show("focus"))},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handlePopupBlur=e=>{let t=e.composedPath();t.includes(this)||t.includes(this.body)||this.hide()},this.handleWebviewBlur=()=>{this.hide()},this.handleWebviewMouseDown=e=>{let t=e.composedPath();t.includes(this)||t.includes(this.body)||this.hide()},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let e=ep(getComputedStyle(this).getPropertyValue("--show-delay"));this.hoverTimeout=setTimeout(()=>this.show("hover"),e)}},this.handleMouseOut=e=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let t=e.composedPath();if(t[t.length-2]===this||this.hasPopupFocus()||"hover"!==this._triggeredBy)return;let o=ep(getComputedStyle(this).getPropertyValue("--hide-delay"));this.hoverTimeout=setTimeout(()=>this.hide(),o)}},this.addEventListener("blur",this.handleTriggerBlur,!0),this.addEventListener("focus",this.handleTriggerFocus,!0),this.addEventListener("click",this.handleTriggerClick),this.addEventListener("mousedown",this.handleTriggerMouseDown),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static closeOthers(e){for(let t of nw.openPopovers)t===e||t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_CONTAINS||t.hide()}get currentPlacement(){return this.popup?.getAttribute("data-current-placement")??this.placement}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleWebviewMouseDown),nw.openPopovers.delete(this),super.disconnectedCallback?.()}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}render(){return tw`<sl-popup
	...
	`,nU([tI()],nF.prototype,"name",2),nU([tI()],nF.prototype,"url",2),nU([tI()],nF.prototype,"avatarUrl",2),nU([tI({type:Boolean,attribute:"show-avatar",reflect:!0})],nF.prototype,"showAvatar",2),nF=nU([tT("gl-commit-author")],nF);var nH=Object.defineProperty,nq=Object.getOwnPropertyDescriptor,nV=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?nq(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&nH(t,o,a),a};let nW=class extends lit_element_i{constructor(){super(...arguments),this.dateFormat="MMMM Do, YYYY h:mma",this.dateStyle="relative",this.committer=!1}get absoluteDate(){return this.dateElement.absoluteDate}get dateLabel(){return this.dateElement.dateLabel}render(){return tw`<code-icon icon="git-commit"></code-icon>
			<formatted-date
				.date=${this.date}
				.format=${this.dateFormat}
				.dateStyle=${this.dateStyle}
					...
					<div class="message-block-row message-block-row--actions">
						...
						${tN(!this.isStash,()=>tw`
								<gl-commit-date
									...
									.actionLabel="${e.sha===a6?"Modified":"Committed"}"
								></gl-commit-date>
							`)}
					</div>
				</div>
...
<a href="${r$("gitlens.plus.cloudIntegrations.connect",{source:{source:"inspect",detail:{action:"connect"}}})}">Connect an Integration</a> &mdash;`,this.state?.hasAccount||(n+=" sign up and"),n+=" to get access to automatic rich autolinks for services like Jira, GitHub, and more."),tw`<gl-action-chip
		...
		`}onExplainChanges(e){if(!0===this.explainBusy||e instanceof KeyboardEvent&&"Enter"!==e.key){e.preventDefault(),e.stopPropagation();return}this.explainBusy=!0}renderCommitStats(e){if(e?.files==null)return;if("number"==typeof e.files)return tw`<commit-stats added="?" modified="${e.files}" removed="?"></commit-stats>`;let{added:t,deleted:o,changed:r}=e.files;return tw`<commit-stats added="${t}" modified="${r}" removed="${o}"></commit-stats>`}getFileActions(e,t){let o=[{icon:"go-to-file",label:"Open file",action:"file-open"}];return this.isUncommitted||(o.push({icon:"git-compare",label:"Open Changes with Working File",action:"file-compare-working"}),this.isStash||o.push({icon:"globe",label:"Open on remote",action:"file-open-on-remote"}),o.push({icon:"ellipsis",label:"Show more actions",action:"file-more-actions"})),o}};ax([tI({type:Object})],a$.prototype,"state",2),ax([tD()],a$.prototype,"isStash",1),ax([tD()],a$.prototype,"shortSha",1),ax([tD()],a$.prototype,"explainBusy",2),ax([tI({type:Object})],a$.prototype,"explain",2),a$=ax([tT("gl-commit-details")],a$);let a_=(e,t,o)=>{let r=new Map;for(let n=t;n<=o;n++)r.set(e[n],n);return r},aC=iV(class extends directive_i{constructor(e){if(super(e),2!==e.type)throw Error("repeat() can only be used in text expressions")}dt(e,t,o){let r;void 0===o?o=t:void 0!==t&&(r=t);let n=[],a=[],c=0;for(let t of e)n[c]=r?r(t,c):c,a[c]=o(t,c),c++;return{values:a,keys:n}}render(e,t,o){return this.dt(e,t,o).values}update(e,[t,o,r]){let n=e._$AH,{values:a,keys:c}=this.dt(t,o,r);if(!Array.isArray(n))return this.ut=c,a;let d=this.ut??=[],h=[],p,u,g=0,f=n.length-1,m=0,b=a.length-1;for(;g<=f&&m<=b;)if(null===n[g])g++;else if(null===n[f])f--;else if(d[g]===c[m])h[m]=n1(n[g],a[m]),g++,m++;else if(d[f]===c[b])h[b]=n1(n[f],a[b]),f--,b--;else if(d[g]===c[b])h[b]=n1(n[g],a[b]),n0(e,h[b+1],n[g]),g++,b--;else if(d[f]===c[m])h[m]=n1(n[f],a[m]),n0(e,n[g],n[f]),f--,m++;else if(void 0===p&&(p=a_(c,m,b),u=a_(d,g,f)),p.has(d[g]))if(p.has(d[f])){let t=u.get(c[m]),o=void 0!==t?n[t]:null;if(null===o){let t=n0(e,n[g]);n1(t,a[m]),h[m]=t}else h[m]=n1(o,a[m]),n0(e,n[g],o),n[t]=null;m++}else n5(n[f]),f--;else n5(n[g]),g++;for(;m<=b;){let t=n0(e,h[b+1]);n1(t,a[m]),h[m++]=t}for(;g<=f;){let e=n[g++];null!==e&&n5(e)}return this.ut=c,((e,t=n2)=>e._$AH=t)(e,h),tk}});var aS=Object.defineProperty,aA=Object.getOwnPropertyDescriptor,aE=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?aA(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&aS(t,o,a),a};let aP=class extends lit_element_i{constructor(){super(...arguments),this.editor=!1,this.layout="shift",this.grouping="gap"}render(){return tw`<div class="group"><slot></slot></div>`}};aP.styles=[rE,eK`
			:host {
		...
		`],aE([tI({type:Boolean})],aP.prototype,"editor",2),aE([tI({reflect:!0})],aP.prototype,"layout",2),aE([tI({reflect:!0})],aP.prototype,"grouping",2),aP=aE([tT("button-container")],aP);let aR=eK`
	.button-container {
		margin: 1rem auto 0;
		text-align: left;
		max-width: 30rem;
...
`;var aT=Object.defineProperty,aO=Object.getOwnPropertyDescriptor,aI=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?aO(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&aT(t,o,a),a};let aD=class extends lit_element_i{constructor(){super(...arguments),this.lines=1}render(){let e=`--skeleton-lines: ${this.lines};`;return tw`<div class="skeleton" style=${e}></div>`}};aD.styles=eK`
		:host {
	...
	`,aI([tI({type:Number})],aD.prototype,"lines",2),aD=aI([tT("skeleton-loader")],aD);let GlTreeBase=class GlTreeBase extends GlElement{renderLoading(){return tw`
		...
		`],aU([tI({type:Object})],aF.prototype,"orgSettings",2),aU([tI({type:Object})],aF.prototype,"preferences",2),aU([tI({type:Object})],aF.prototype,"generate",2),aU([tI({type:Object})],aF.prototype,"createState",2),aF=aU([tT("gl-inspect-patch")],aF);var aH=Object.defineProperty,aq=Object.getOwnPropertyDescriptor,aV=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?aq(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&aH(t,o,a),a};let aW=class extends GlDetailsBase{constructor(){super(),this.tab="wip",this.experimentalComposerEnabled=!1,this.patchCreateMetadata={title:void 0,description:void 0},eF(eM)}get inReview(){return this.draftState?.inReview??!1}get isUnpublished(){let e=this.wip?.branch;return e?.upstream==null||!0===e.upstream.missing}get draftsEnabled(){return this.orgSettings?.drafts===!0}get filesCount(){return this.files?.length??0}get branchState(){let e=this.wip?.branch;if(null!=e)return{ahead:e.tracking?.ahead??0,behind:e.tracking?.behind??0}}get patchCreateState(){let e=this.wip,t=e.repo.uri,o={type:"wip",repository:{name:e.repo.name,path:e.repo.path,uri:e.repo.uri},revision:{to:"0000000000000000000000000000000000000000",from:"HEAD"},files:e.changes?.files??[],checked:!0};return{...this.patchCreateMetadata,changes:{[t]:o},creationError:void 0,visibility:"public",userSelections:void 0}}get codeSuggestions(){return this.wip?.codeSuggestions??[]}updated(e){super.updated(e),e.has("generate")&&(this.patchCreateMetadata={title:this.generate?.title??this.patchCreateMetadata.title,description:this.generate?.description??this.patchCreateMetadata.description})}get filesChangedPaneLabel(){return"Working Changes"}renderChangedFilesActions(){if(this.files?.length)return tw`<div class="section section--actions">
			...
			`:(this.wip?.changes?.files.length??0)!==0?tw`
			<gl-button
				?full=${!e}
				appearance="secondary"
				data-action="${a}"
		...
		`:void 0}renderPrimaryAction(){if(this.isUnpublished)return tw`
			...
			`;if(null==this.branchState)return;let{ahead:e,behind:t}=this.branchState;if(0===e&&0===t)return;let o=t>0?"Pull":e>0?"Push":"Fetch";return tw`
			<gl-button
				full
		...
		`}renderActions(){let e=this.renderPrimaryAction(),t=this.renderSecondaryAction(null!=e);return null==e&&null==t?tx:tw`<div class="section section--actions">
			<button-container>${e}${t}</button-container>
		</div>`}renderSuggestedChanges(){return 0===this.codeSuggestions.length?tx:tw`
			<gl-tree>
...
`;var aK=Object.defineProperty,aZ=Object.getOwnPropertyDescriptor,aY=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?aZ(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&aK(t,o,a),a};let aX=class extends lit_element_i{constructor(){super(...arguments),this.pinned=!1,this.uncommitted=!1,this.shortSha=""}get navigationState(){if(null==this.navigation)return{back:!1,forward:!1};let e={back:!0,forward:!0};return this.navigation.count<=1?(e.back=!1,e.forward=!1):0===this.navigation.position?(e.back=!0,e.forward=!1):this.navigation.position===this.navigation.count-1&&(e.back=!1,e.forward=!0),e}handleAction(e){let t=e.target,o=t.dataset.action;if(null!=o)if("commit-actions"===o){let o=e instanceof MouseEvent&&e.altKey;this.fireEvent("commit-actions",{action:t.dataset.actionType,alt:o})}else this.fireEvent(o)}fireEvent(e,t){this.dispatchEvent(new CustomEvent(`gl-${e}`,{detail:t}))}render(){let e=this.pinned?tw`Unpin this Commit<br />Restores Automatic Following`:tw`Pin this Commit<br />Suspends Automatic Following`,t="Forward",o="Back";return this.navigation?.hint&&(this.pinned?o+=` - ${this.navigation.hint}`:t+=` - ${this.navigation.hint}`),tw`
		...
		`],aY([tI({type:Boolean,reflect:!0})],aX.prototype,"pinned",2),aY([tI({type:Boolean})],aX.prototype,"uncommitted",2),aY([tI({type:Object})],aX.prototype,"navigation",2),aY([tI()],aX.prototype,"shortSha",2),aY([tI()],aX.prototype,"stashNumber",2),aX=aY([tT("gl-inspect-nav")],aX);var aQ=Object.defineProperty,aJ=Object.getOwnPropertyDescriptor,a0=(e,t,o,r)=>{for(var n,a=r>1?void 0:r?aJ(t,o):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&aQ(t,o,a),a};let a1=class extends lit_element_i{render(){if(null==this.wip)return tx;let e=this.wip.changes,t=this.wip.branch;if(null==e||null==t)return tx;let o="git-pull-request";if(this.wip.pullRequest?.state)switch(this.wip.pullRequest?.state){case"merged":o="git-merge";break;case"closed":o="git-pull-request-closed"}return tw`
			<div class="group">
		...
		`}handleAction(e,t){let o=e instanceof MouseEvent&&e.altKey;this.dispatchEvent(new CustomEvent("gl-branch-action",{detail:{action:t,alt:o}}))}};a1.styles=[aG,eK`
			*,
			*::before,
			*::after {
				box-sizing: border-box;
