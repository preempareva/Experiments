...
`,rW=class extends lit_element_i{constructor(){let e;super(),(e=v).has(this)?rw("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(this):e.set(this,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let o=new CustomEvent(e,rk({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(o),o}static define(e,t=this,o={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,o)}catch(r){customElements.define(e,class extends t{},o)}return}let i=" (unknown version)",n=i;if("version"in t&&t.version&&(i=" v"+t.version),"version"in r&&r.version&&(n=" v"+r.version),i&&n&&i===n)return}attributeChangedCallback(e,t,o){let r,i;if(rC(this,r=v,"read from private field"),i?!i.call(this):!r.get(this)){let e,t;this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])}),rC(this,e=v,"write to private field"),t?t.call(this,!0):e.set(this,!0)}super.attributeChangedCallback(e,t,o)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,o)=>{e.has(o)&&null==this[o]&&(this[o]=t)})}};v=new WeakMap,rW.version="2.20.1",rW.dependencies={},rx([eT()],rW.prototype,"dir",2),rx([eT()],rW.prototype,"lang",2);let rH=Math.min,rG=Math.max,rV=Math.round,rK=Math.floor,rY=e=>({x:e,y:e}),rZ={left:"right",right:"left",bottom:"top",top:"bottom"},rJ={start:"end",end:"start"};function rX(e,t){return"function"==typeof e?e(t):e}function rQ(e){return e.split("-")[0]}function r0(e){return e.split("-")[1]}function r1(e){return"x"===e?"y":"x"}function r2(e){return"y"===e?"height":"width"}let r5=new Set(["top","bottom"]);function r8(e){return r5.has(rQ(e))?"y":"x"}function r6(e){return e.replace(/start|end/g,e=>rJ[e])}let r4=["left","right"],r3=["right","left"],r9=["top","bottom"],r7=["bottom","top"];function ie(e){return e.replace(/left|right|bottom|top/g,e=>rZ[e])}function it(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function io(e){let{x:t,y:o,width:r,height:i}=e;return{width:r,height:i,top:o,left:t,right:t+r,bottom:o+i,x:t,y:o}}function ir(e,t,o){let r,{reference:i,floating:n}=e,a=r8(t),l=r1(r8(t)),c=r2(l),d=rQ(t),h="y"===a,p=i.x+i.width/2-n.width/2,u=i.y+i.height/2-n.height/2,g=i[c]/2-n[c]/2;switch(d){case"top":r={x:p,y:i.y-n.height};break;case"bottom":r={x:p,y:i.y+i.height};break;case"right":r={x:i.x+i.width,y:u};break;case"left":r={x:i.x-n.width,y:u};break;default:r={x:i.x,y:i.y}}switch(r0(t)){case"start":r[l]-=g*(o&&h?-1:1);break;case"end":r[l]+=g*(o&&h?-1:1)}return r}let ii=async(e,t,o)=>{let{placement:r="bottom",strategy:i="absolute",middleware:n=[],platform:a}=o,l=n.filter(Boolean),c=await (null==a.isRTL?void 0:a.isRTL(t)),d=await a.getElementRects({reference:e,floating:t,strategy:i}),{x:h,y:p}=ir(d,r,c),u=r,g={},m=0;for(let o=0;o<l.length;o++){let{name:n,fn:b}=l[o],{x:f,y:v,data:w,reset:_}=await b({x:h,y:p,initialPlacement:r,placement:u,strategy:i,middlewareData:g,rects:d,platform:a,elements:{reference:e,floating:t}});h=null!=f?f:h,p=null!=v?v:p,g={...g,[n]:{...g[n],...w}},_&&m<=50&&(m++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(d=!0===_.rects?await a.getElementRects({reference:e,floating:t,strategy:i}):_.rects),{x:h,y:p}=ir(d,u,c)),o=-1)}return{x:h,y:p,placement:u,strategy:i,middlewareData:g}};async function is(e,t){var o;void 0===t&&(t={});let{x:r,y:i,platform:n,rects:a,elements:l,strategy:c}=e,{boundary:d="clippingAncestors",rootBoundary:h="viewport",elementContext:p="floating",altBoundary:u=!1,padding:g=0}=rX(t,e),m=it(g),b=l[u?"floating"===p?"reference":"floating":p],f=io(await n.getClippingRect({element:null==(o=await (null==n.isElement?void 0:n.isElement(b)))||o?b:b.contextElement||await (null==n.getDocumentElement?void 0:n.getDocumentElement(l.floating)),boundary:d,rootBoundary:h,strategy:c})),v="floating"===p?{x:r,y:i,width:a.floating.width,height:a.floating.height}:a.reference,w=await (null==n.getOffsetParent?void 0:n.getOffsetParent(l.floating)),_=await (null==n.isElement?void 0:n.isElement(w))&&await (null==n.getScale?void 0:n.getScale(w))||{x:1,y:1},$=io(n.convertOffsetParentRelativeRectToViewportRelativeRect?await n.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:v,offsetParent:w,strategy:c}):v);return{top:(f.top-$.top+m.top)/_.y,bottom:($.bottom-f.bottom+m.bottom)/_.y,left:(f.left-$.left+m.left)/_.x,right:($.right-f.right+m.right)/_.x}}let ia=new Set(["left","top"]);async function il(e,t){let{placement:o,platform:r,elements:i}=e,n=await (null==r.isRTL?void 0:r.isRTL(i.floating)),a=rQ(o),l=r0(o),c="y"===r8(o),d=ia.has(a)?-1:1,h=n&&c?-1:1,p=rX(t,e),{mainAxis:u,crossAxis:g,alignmentAxis:m}="number"==typeof p?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return l&&"number"==typeof m&&(g="end"===l?-1*m:m),c?{x:g*h,y:u*d}:{x:u*d,y:g*h}}function ic(){return"undefined"!=typeof window}function id(e){return iu(e)?(e.nodeName||"").toLowerCase():"#document"}function ih(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function ip(e){var t;return null==(t=(iu(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function iu(e){return!!ic()&&(e instanceof Node||e instanceof ih(e).Node)}function ig(e){return!!ic()&&(e instanceof Element||e instanceof ih(e).Element)}function im(e){return!!ic()&&(e instanceof HTMLElement||e instanceof ih(e).HTMLElement)}function ib(e){return!!ic()&&"undefined"!=typeof ShadowRoot&&(e instanceof ShadowRoot||e instanceof ih(e).ShadowRoot)}let iv=new Set(["inline","contents"]);function iy(e){let{overflow:t,overflowX:o,overflowY:r,display:i}=iR(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+o)&&!iv.has(i)}let iw=new Set(["table","td","th"]),i_=[":popover-open",":modal"];function ik(e){return i_.some(t=>{try{return e.matches(t)}catch{return!1}})}let i$=["transform","translate","scale","rotate","perspective"],ix=["transform","translate","scale","rotate","perspective","filter"],iC=["paint","layout","strict","content"];function iS(e){let t=iP(),o=ig(e)?iR(e):e;return i$.some(e=>!!o[e]&&"none"!==o[e])||!!o.containerType&&"normal"!==o.containerType||!t&&!!o.backdropFilter&&"none"!==o.backdropFilter||!t&&!!o.filter&&"none"!==o.filter||ix.some(e=>(o.willChange||"").includes(e))||iC.some(e=>(o.contain||"").includes(e))}function iP(){return"undefined"!=typeof CSS&&!!CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")}let iO=new Set(["html","body","#document"]);function iA(e){return iO.has(id(e))}function iR(e){return ih(e).getComputedStyle(e)}function iI(e){return ig(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function iB(e){if("html"===id(e))return e;let t=e.assignedSlot||e.parentNode||ib(e)&&e.host||ip(e);return ib(t)?t.host:t}function iE(e,t,o){var r;void 0===t&&(t=[]),void 0===o&&(o=!0);let i=function e(t){let o=iB(t);return iA(o)?t.ownerDocument?t.ownerDocument.body:t.body:im(o)&&iy(o)?o:e(o)}(e),n=i===(null==(r=e.ownerDocument)?void 0:r.body),a=ih(i);if(n){let e=iT(a);return t.concat(a,a.visualViewport||[],iy(i)?i:[],e&&o?iE(e):[])}return t.concat(i,iE(i,[],o))}function iT(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function iL(e){let t=iR(e),o=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=im(e),n=i?e.offsetWidth:o,a=i?e.offsetHeight:r,l=rV(o)!==n||rV(r)!==a;return l&&(o=n,r=a),{width:o,height:r,$:l}}function iz(e){return ig(e)?e:e.contextElement}function iD(e){let t=iz(e);if(!im(t))return rY(1);let o=t.getBoundingClientRect(),{width:r,height:i,$:n}=iL(t),a=(n?rV(o.width):o.width)/r,l=(n?rV(o.height):o.height)/i;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}let iN=rY(0);function iM(e){let t=ih(e);return iP()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:iN}function ij(e,t,o,r){var i;void 0===t&&(t=!1),void 0===o&&(o=!1);let n=e.getBoundingClientRect(),a=iz(e),l=rY(1);t&&(r?ig(r)&&(l=iD(r)):l=iD(e));let c=(void 0===(i=o)&&(i=!1),r&&(!i||r===ih(a))&&i)?iM(a):rY(0),d=(n.left+c.x)/l.x,h=(n.top+c.y)/l.y,p=n.width/l.x,u=n.height/l.y;if(a){let e=ih(a),t=r&&ig(r)?ih(r):r,o=e,i=iT(o);for(;i&&r&&t!==o;){let e=iD(i),t=i.getBoundingClientRect(),r=iR(i),n=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,a=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;d*=e.x,h*=e.y,p*=e.x,u*=e.y,d+=n,h+=a,i=iT(o=ih(i))}}return io({width:p,height:u,x:d,y:h})}function iF(e,t){let o=iI(e).scrollLeft;return t?t.left+o:ij(ip(e)).left+o}function iq(e,t,o){void 0===o&&(o=!1);let r=e.getBoundingClientRect();return{x:r.left+t.scrollLeft-(o?0:iF(e,r)),y:r.top+t.scrollTop}}let iU=new Set(["absolute","fixed"]);function iW(e,t,o){let r;if("viewport"===t)r=function(e,t){let o=ih(e),r=ip(e),i=o.visualViewport,n=r.clientWidth,a=r.clientHeight,l=0,c=0;if(i){n=i.width,a=i.height;let e=iP();(!e||e&&"fixed"===t)&&(l=i.offsetLeft,c=i.offsetTop)}return{width:n,height:a,x:l,y:c}}(e,o);else if("document"===t)r=function(e){let t=ip(e),o=iI(e),r=e.ownerDocument.body,i=rG(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),n=rG(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),a=-o.scrollLeft+iF(e),l=-o.scrollTop;return"rtl"===iR(r).direction&&(a+=rG(t.clientWidth,r.clientWidth)-i),{width:i,height:n,x:a,y:l}}(ip(e));else if(ig(t))r=function(e,t){let o=ij(e,!0,"fixed"===t),r=o.top+e.clientTop,i=o.left+e.clientLeft,n=im(e)?iD(e):rY(1),a=e.clientWidth*n.x,l=e.clientHeight*n.y;return{width:a,height:l,x:i*n.x,y:r*n.y}}(t,o);else{let o=iM(e);r={x:t.x-o.x,y:t.y-o.y,width:t.width,height:t.height}}return io(r)}function iH(e){return"static"===iR(e).position}function iG(e,t){if(!im(e)||"fixed"===iR(e).position)return null;if(t)return t(e);let o=e.offsetParent;return ip(e)===o&&(o=o.ownerDocument.body),o}function iV(e,t){var o;let r=ih(e);if(ik(e))return r;if(!im(e)){let t=iB(e);for(;t&&!iA(t);){if(ig(t)&&!iH(t))return t;t=iB(t)}return r}let i=iG(e,t);for(;i&&(o=i,iw.has(id(o)))&&iH(i);)i=iG(i,t);return i&&iA(i)&&iH(i)&&!iS(i)?r:i||function(e){let t=iB(e);for(;im(t)&&!iA(t);){if(iS(t))return t;if(ik(t))break;t=iB(t)}return null}(e)||r}let iK=async function(e){let t=this.getOffsetParent||iV,o=this.getDimensions,r=await o(e.floating);return{reference:function(e,t,o){let r=im(t),i=ip(t),n="fixed"===o,a=ij(e,!0,n,t),l={scrollLeft:0,scrollTop:0},c=rY(0);if(r||!r&&!n)if(("body"!==id(t)||iy(i))&&(l=iI(t)),r){let e=ij(t,!0,n,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&(c.x=iF(i));n&&!r&&i&&(c.x=iF(i));let d=!i||r||n?rY(0):iq(i,l);return{x:a.left+l.scrollLeft-c.x-d.x,y:a.top+l.scrollTop-c.y-d.y,width:a.width,height:a.height}}(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}},iY={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:o,offsetParent:r,strategy:i}=e,n="fixed"===i,a=ip(r),l=!!t&&ik(t.floating);if(r===a||l&&n)return o;let c={scrollLeft:0,scrollTop:0},d=rY(1),h=rY(0),p=im(r);if((p||!p&&!n)&&(("body"!==id(r)||iy(a))&&(c=iI(r)),im(r))){let e=ij(r);d=iD(r),h.x=e.x+r.clientLeft,h.y=e.y+r.clientTop}let u=!a||p||n?rY(0):iq(a,c,!0);return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-c.scrollLeft*d.x+h.x+u.x,y:o.y*d.y-c.scrollTop*d.y+h.y+u.y}},getDocumentElement:ip,getClippingRect:function(e){let{element:t,boundary:o,rootBoundary:r,strategy:i}=e,n=[..."clippingAncestors"===o?ik(t)?[]:function(e,t){let o=t.get(e);if(o)return o;let r=iE(e,[],!1).filter(e=>ig(e)&&"body"!==id(e)),i=null,n="fixed"===iR(e).position,a=n?iB(e):e;for(;ig(a)&&!iA(a);){let t=iR(a),o=iS(a);o||"fixed"!==t.position||(i=null),(n?!o&&!i:!o&&"static"===t.position&&!!i&&iU.has(i.position)||iy(a)&&!o&&function e(t,o){let r=iB(t);return!(r===o||!ig(r)||iA(r))&&("fixed"===iR(r).position||e(r,o))}(e,a))?r=r.filter(e=>e!==a):i=t,a=iB(a)}return t.set(e,r),r}(t,this._c):[].concat(o),r],a=n[0],l=n.reduce((e,o)=>{let r=iW(t,o,i);return e.top=rG(r.top,e.top),e.right=rH(r.right,e.right),e.bottom=rH(r.bottom,e.bottom),e.left=rG(r.left,e.left),e},iW(t,a,i));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:iV,getElementRects:iK,getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){let{width:t,height:o}=iL(e);return{width:t,height:o}},getScale:iD,isElement:ig,isRTL:function(e){return"rtl"===iR(e).direction}};function iZ(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}let iJ=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var o,r;let i,n,{placement:a,rects:l,platform:c,elements:d}=t,{apply:h=()=>{},...p}=rX(e,t),u=await is(t,p),g=rQ(a),m=r0(a),b="y"===r8(a),{width:f,height:v}=l.floating;"top"===g||"bottom"===g?(i=g,n=m===(await (null==c.isRTL?void 0:c.isRTL(d.floating))?"start":"end")?"left":"right"):(n=g,i="end"===m?"top":"bottom");let w=v-u.top-u.bottom,_=f-u.left-u.right,$=rH(v-u[i],w),x=rH(f-u[n],_),C=!t.middlewareData.shift,S=$,P=x;if(null!=(o=t.middlewareData.shift)&&o.enabled.x&&(P=_),null!=(r=t.middlewareData.shift)&&r.enabled.y&&(S=w),C&&!m){let e=rG(u.left,0),t=rG(u.right,0),o=rG(u.top,0),r=rG(u.bottom,0);b?P=f-2*(0!==e||0!==t?e+t:rG(u.left,u.right)):S=v-2*(0!==o||0!==r?o+r:rG(u.top,u.bottom))}await h({...t,availableWidth:P,availableHeight:S});let O=await c.getDimensions(d.floating);return f!==O.width||v!==O.height?{reset:{rects:!0}}:{}}}},iX=tN(class extends directive_i{constructor(e){if(super(e),1!==e.type||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this.st){for(let o in this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e))),t)t[o]&&!this.nt?.has(o)&&this.st.add(o);return this.render(t)}let o=e.element.classList;for(let e of this.st)e in t||(o.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(o.add(e),this.st.add(e)):(o.remove(e),this.st.delete(e)))}return ek}});function iQ(e){var t=e;for(let e=t;e;e=i0(e))if(e instanceof Element&&"none"===getComputedStyle(e).display)return null;for(let e=i0(t);e;e=i0(e)){if(!(e instanceof Element))continue;let t=getComputedStyle(e);if("contents"!==t.display&&("static"!==t.position||iS(t)||"BODY"===e.tagName))return e}return null}function i0(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}var i1=class extends rW{constructor(){super(...arguments),this.localize=new rq(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom"),r=0,i=0,n=0,a=0,l=0,c=0,d=0,h=0;o?e.top<t.top?(r=e.left,i=e.bottom,n=e.right,a=e.bottom,l=t.left,c=t.top,d=t.right,h=t.top):(r=t.left,i=t.bottom,n=t.right,a=t.bottom,l=e.left,c=e.top,d=e.right,h=e.top):e.left<t.left?(r=e.right,i=e.top,n=t.left,a=t.top,l=e.right,c=e.bottom,d=t.left,h=t.bottom):(r=t.right,i=t.top,n=e.left,a=e.top,l=t.right,c=t.bottom,d=e.left,h=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${r}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${n}px`),this.style.setProperty("--hover-bridge-top-right-y",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else{var e;this.anchor instanceof Element||null!==(e=this.anchor)&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e.contextElement instanceof Element)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]')}this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(this.cleanup=function(e,t,o,r){let i;void 0===r&&(r={});let{ancestorScroll:n=!0,ancestorResize:a=!0,elementResize:l="function"==typeof ResizeObserver,layoutShift:c="function"==typeof IntersectionObserver,animationFrame:d=!1}=r,h=iz(e),p=n||a?[...h?iE(h):[],...iE(t)]:[];p.forEach(e=>{n&&e.addEventListener("scroll",o,{passive:!0}),a&&e.addEventListener("resize",o)});let u=h&&c?function(e,t){let o,r=null,i=ip(e);function n(){var e;clearTimeout(o),null==(e=r)||e.disconnect(),r=null}return!function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),n();let d=e.getBoundingClientRect(),{left:h,top:p,width:u,height:g}=d;if(l||t(),!u||!g)return;let m=rK(p),b=rK(i.clientWidth-(h+u)),f={rootMargin:-m+"px "+-b+"px "+-rK(i.clientHeight-(p+g))+"px "+-rK(h)+"px",threshold:rG(0,rH(1,c))||1},v=!0;function w(t){let r=t[0].intersectionRatio;if(r!==c){if(!v)return a();r?a(!1,r):o=setTimeout(()=>{a(!1,1e-7)},1e3)}1!==r||iZ(d,e.getBoundingClientRect())||a(),v=!1}try{r=new IntersectionObserver(w,{...f,root:i.ownerDocument})}catch{r=new IntersectionObserver(w,f)}r.observe(e)}(!0),n}(h,o):null,g=-1,m=null;l&&(m=new ResizeObserver(e=>{let[r]=e;r&&r.target===h&&m&&(m.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame(()=>{var e;null==(e=m)||e.observe(t)})),o()}),h&&!d&&m.observe(h),m.observe(t));let b=d?ij(e):null;return d&&function t(){let r=ij(e);b&&!iZ(b,r)&&o(),b=r,i=requestAnimationFrame(t)}(),o(),()=>{var e;p.forEach(e=>{n&&e.removeEventListener("scroll",o),a&&e.removeEventListener("resize",o)}),null==u||u(),null==(e=m)||e.disconnect(),m=null,d&&cancelAnimationFrame(i)}}(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){var e,t,o;let r;if(!this.active||!this.anchorEl)return;let i=[{name:"offset",options:e={mainAxis:this.distance,crossAxis:this.skidding},async fn(t){var o,r;let{x:i,y:n,placement:a,middlewareData:l}=t,c=await il(t,e);return a===(null==(o=l.offset)?void 0:o.placement)&&null!=(r=l.arrow)&&r.alignmentOffset?{}:{x:i+c.x,y:n+c.y,data:{...c,placement:a}}}}];this.sync?i.push(iJ({apply:({rects:e})=>{let t="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=o?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&i.push({name:"flip",options:t={boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding},async fn(e){var o,r,i,n,a;let{placement:l,middlewareData:c,rects:d,initialPlacement:h,platform:p,elements:u}=e,{mainAxis:g=!0,crossAxis:m=!0,fallbackPlacements:b,fallbackStrategy:f="bestFit",fallbackAxisSideDirection:v="none",flipAlignment:w=!0,..._}=rX(t,e);if(null!=(o=c.arrow)&&o.alignmentOffset)return{};let $=rQ(l),x=r8(h),C=rQ(h)===h,S=await (null==p.isRTL?void 0:p.isRTL(u.floating)),P=b||(C||!w?[ie(h)]:function(e){let t=ie(e);return[r6(e),t,r6(t)]}(h)),O="none"!==v;!b&&O&&P.push(...function(e,t,o,r){let i=r0(e),n=function(e,t,o){switch(e){case"top":case"bottom":if(o)return t?r3:r4;return t?r4:r3;case"left":case"right":return t?r9:r7;default:return[]}}(rQ(e),"start"===o,r);return i&&(n=n.map(e=>e+"-"+i),t&&(n=n.concat(n.map(r6)))),n}(h,w,v,S));let A=[h,...P],B=await is(e,_),E=[],T=(null==(r=c.flip)?void 0:r.overflows)||[];if(g&&E.push(B[$]),m){let e=function(e,t,o){void 0===o&&(o=!1);let r=r0(e),i=r1(r8(e)),n=r2(i),a="x"===i?r===(o?"end":"start")?"right":"left":"start"===r?"bottom":"top";return t.reference[n]>t.floating[n]&&(a=ie(a)),[a,ie(a)]}(l,d,S);E.push(B[e[0]],B[e[1]])}if(T=[...T,{placement:l,overflows:E}],!E.every(e=>e<=0)){let e=((null==(i=c.flip)?void 0:i.index)||0)+1,t=A[e];if(t&&("alignment"!==m||x===r8(t)||T.every(e=>r8(e.placement)!==x||e.overflows[0]>0)))return{data:{index:e,overflows:T},reset:{placement:t}};let o=null==(n=T.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:n.placement;if(!o)switch(f){case"bestFit":{let e=null==(a=T.filter(e=>{if(O){let t=r8(e.placement);return t===x||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:a[0];e&&(o=e);break}case"initialPlacement":o=h}if(l!==o)return{reset:{placement:o}}}return{}}}),this.shift&&i.push({name:"shift",options:o={boundary:this.shiftBoundary,padding:this.shiftPadding},async fn(e){let{x:t,y:r,placement:i}=e,{mainAxis:n=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:o}=e;return{x:t,y:o}}},...c}=rX(o,e),d={x:t,y:r},h=await is(e,c),p=r8(rQ(i)),u=r1(p),g=d[u],m=d[p];if(n){let e="y"===u?"top":"left",t="y"===u?"bottom":"right",o=g+h[e],r=g-h[t];g=rG(o,rH(g,r))}if(a){let e="y"===p?"top":"left",t="y"===p?"bottom":"right",o=m+h[e],r=m-h[t];m=rG(o,rH(m,r))}let b=l.fn({...e,[u]:g,[p]:m});return{...b,data:{x:b.x-t,y:b.y-r,enabled:{[u]:n,[p]:a}}}}}),this.autoSize?i.push(iJ({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&i.push({name:"arrow",options:r={element:this.arrowEl,padding:this.arrowPadding},async fn(e){let{x:t,y:o,placement:i,rects:n,platform:a,elements:l,middlewareData:c}=e,{element:d,padding:h=0}=rX(r,e)||{};if(null==d)return{};let p=it(h),u={x:t,y:o},g=r1(r8(i)),m=r2(g),b=await a.getDimensions(d),f="y"===g,v=f?"clientHeight":"clientWidth",w=n.reference[m]+n.reference[g]-u[g]-n.floating[m],_=u[g]-n.reference[g],$=await (null==a.getOffsetParent?void 0:a.getOffsetParent(d)),x=$?$[v]:0;x&&await (null==a.isElement?void 0:a.isElement($))||(x=l.floating[v]||n.floating[m]);let C=x/2-b[m]/2-1,S=rH(p[f?"top":"left"],C),P=rH(p[f?"bottom":"right"],C),O=x-b[m]-P,A=x/2-b[m]/2+(w/2-_/2),B=rG(S,rH(A,O)),E=!c.arrow&&null!=r0(i)&&A!==B&&n.reference[m]/2-(A<S?S:P)-b[m]/2<0,T=E?A<S?A-S:A-O:0;return{[g]:u[g]+T,data:{[g]:B,centerOffset:A-B-T,...E&&{alignmentOffset:T}},reset:E}}});let n="absolute"===this.strategy?e=>iY.getOffsetParent(e,iQ):iY.getOffsetParent;((e,t,o)=>{let r=new Map,i={platform:iY,...o},n={...i.platform,_c:r};return ii(e,t,{...i,platform:n})})(this.anchorEl,this.popup,{placement:this.placement,middleware:i,strategy:this.strategy,platform:r$(rk({},iY),{getOffsetParent:n})}).then(({x:e,y:t,middlewareData:o,placement:r})=>{let i="rtl"===this.localize.dir(),n={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]];if(this.setAttribute("data-current-placement",r),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=o.arrow.x,t=o.arrow.y,r="",a="",l="",c="";if("start"===this.arrowPlacement){let o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";r="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=i?o:"",c=i?"":o}else if("end"===this.arrowPlacement){let o="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=i?"":o,c=i?o:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",r="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",r="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:r,right:a,bottom:l,left:c,[n]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return ew`
      <slot name="anchor" @slotchange=${this.handleAnchorChange}></slot>

      <span
        part="hover-bridge"
        class=${iX({"popup-hover-bridge":!0,"popup-hover-bridge--visible":this.hoverBridge&&this.active})}
      ></span>

      <div
        part="popup"
        class=${iX({popup:!0,"popup--active":this.active,"popup--fixed":"fixed"===this.strategy,"popup--has-arrow":this.arrow})}
      >
        <slot></slot>
        ${this.arrow?ew`<div part="arrow" class="popup__arrow" role="presentation"></div>`:""}
      </div>
    `}};function i2(e,t){return new Promise(o=>{e.addEventListener(t,function r(i){i.target===e&&(e.removeEventListener(t,r),o())})})}function i5(e,t,o){return new Promise(r=>{if((null==o?void 0:o.duration)===1/0)throw Error("Promise-based animations must be finite.");let i=e.animate(t,r$(rk({},o),{duration:window.matchMedia("(prefers-reduced-motion: reduce)").matches?0:o.duration}));i.addEventListener("cancel",r,{once:!0}),i.addEventListener("finish",r,{once:!0})})}function i8(e){return(e=e.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?1e3*parseFloat(e):parseFloat(e)}function i6(e){return Promise.all(e.getAnimations().map(e=>new Promise(t=>{e.cancel(),requestAnimationFrame(t)})))}function i4(e,t){let o=rk({waitUntilFirstUpdate:!1},t);return(t,r)=>{let{update:i}=t,n=Array.isArray(e)?e:[e];t.update=function(e){n.forEach(t=>{if(e.has(t)){let i=e.get(t),n=this[t];i!==n&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[r](i,n)}}),i.call(this,e)}}}i1.styles=[rU,rE],rx([eD(".popup")],i1.prototype,"popup",2),rx([eD(".popup__arrow")],i1.prototype,"arrowEl",2),rx([eT()],i1.prototype,"anchor",2),rx([eT({type:Boolean,reflect:!0})],i1.prototype,"active",2),rx([eT({reflect:!0})],i1.prototype,"placement",2),rx([eT({reflect:!0})],i1.prototype,"strategy",2),rx([eT({type:Number})],i1.prototype,"distance",2),rx([eT({type:Number})],i1.prototype,"skidding",2),rx([eT({type:Boolean})],i1.prototype,"arrow",2),rx([eT({attribute:"arrow-placement"})],i1.prototype,"arrowPlacement",2),rx([eT({attribute:"arrow-padding",type:Number})],i1.prototype,"arrowPadding",2),rx([eT({type:Boolean})],i1.prototype,"flip",2),rx([eT({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map(e=>e.trim()).filter(e=>""!==e),toAttribute:e=>e.join(" ")}})],i1.prototype,"flipFallbackPlacements",2),rx([eT({attribute:"flip-fallback-strategy"})],i1.prototype,"flipFallbackStrategy",2),rx([eT({type:Object})],i1.prototype,"flipBoundary",2),rx([eT({attribute:"flip-padding",type:Number})],i1.prototype,"flipPadding",2),rx([eT({type:Boolean})],i1.prototype,"shift",2),rx([eT({type:Object})],i1.prototype,"shiftBoundary",2),rx([eT({attribute:"shift-padding",type:Number})],i1.prototype,"shiftPadding",2),rx([eT({attribute:"auto-size"})],i1.prototype,"autoSize",2),rx([eT()],i1.prototype,"sync",2),rx([eT({type:Object})],i1.prototype,"autoSizeBoundary",2),rx([eT({attribute:"auto-size-padding",type:Number})],i1.prototype,"autoSizePadding",2),rx([eT({attribute:"hover-bridge",type:Boolean})],i1.prototype,"hoverBridge",2);var i3=class extends rW{constructor(){super(),this.localize=new rq(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){let e=i8(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){let e=i8(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(e=this.closeWatcher)||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await i6(this.body),this.body.hidden=!1,this.popup.active=!0;let{keyframes:t,options:o}=rR(this,"tooltip.show",{dir:this.localize.dir()});await i5(this.popup.popup,t,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await i6(this.body);let{keyframes:e,options:o}=rR(this,"tooltip.hide",{dir:this.localize.dir()});await i5(this.popup.popup,e,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,i2(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,i2(this,"sl-after-hide")}render(){return ew`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
          arrow:base__arrow
        "
        class=${iX({tooltip:!0,"tooltip--open":this.open})}
    ...
    `}};i3.styles=[rU,rB],i3.dependencies={"sl-popup":i1},rx([eD("slot:not([name])")],i3.prototype,"defaultSlot",2),rx([eD(".tooltip__body")],i3.prototype,"body",2),rx([eD("sl-popup")],i3.prototype,"popup",2),rx([eT()],i3.prototype,"content",2),rx([eT()],i3.prototype,"placement",2),rx([eT({type:Boolean,reflect:!0})],i3.prototype,"disabled",2),rx([eT({type:Number})],i3.prototype,"distance",2),rx([eT({type:Boolean,reflect:!0})],i3.prototype,"open",2),rx([eT({type:Number})],i3.prototype,"skidding",2),rx([eT()],i3.prototype,"trigger",2),rx([eT({type:Boolean})],i3.prototype,"hoist",2),rx([i4("open",{waitUntilFirstUpdate:!0})],i3.prototype,"handleOpenChange",1),rx([i4(["content","distance","hoist","placement","skidding"])],i3.prototype,"handleOptionsChange",1),rx([i4("disabled")],i3.prototype,"handleDisabledChange",1),rA("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),rA("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}}),i3.define("sl-tooltip");var i9=Object.defineProperty,i7=Object.getOwnPropertyDescriptor,ne=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?i7(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&i9(t,o,n),n};rA("tooltip.show",null),rA("tooltip.hide",null);let nt=class extends lit_element_i{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver(e=>{for(let t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){let e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}});let e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;e&&this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect(),super.disconnectedCallback?.()}render(){var e;return ew`<sl-tooltip
			.placement=${this.placement}
...
`)?rI(e.replace(/\n\n/g,"<hr>").replace(/\n/g,"<br>")):e}</slot>
	...
	`,ne([eT()],nt.prototype,"content",2),ne([eT({reflect:!0})],nt.prototype,"placement",2),ne([eT({type:Boolean})],nt.prototype,"disabled",2),ne([eT({type:Number})],nt.prototype,"distance",2),ne([eT({type:Boolean})],nt.prototype,"hoist",2),nt=ne([eB("gl-tooltip")],nt);var no=Object.defineProperty,nr=Object.getOwnPropertyDescriptor,ni=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nr(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&no(t,o,n),n};let nn=class extends lit_element_i{constructor(){super(...arguments),this.disabled=!1,this.full=!1,this.tooltipPlacement="bottom",this.truncate=!1}connectedCallback(){super.connectedCallback?.(),this.setAttribute("role",this.href?"link":"button"),this.disabled&&this.setAttribute("aria-disabled",this.disabled.toString())}willUpdate(e){if(e.has("href")&&this.setAttribute("role",this.href?"link":"button"),e.has("disabled")){let t=e.get("disabled");t?this.setAttribute("aria-disabled",t.toString()):this.removeAttribute("aria-disabled")}super.willUpdate(e)}render(){return this.tooltip?ew`<gl-tooltip .content=${this.tooltip} placement=${this.tooltipPlacement??e$}
		...
		>
			<slot name="prefix"></slot><slot class="label"></slot><slot name="suffix"></slot>
		</button>`}onLinkKeypress(e){" "===e.key&&this.control.click()}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};nn.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},nn.styles=[o1,E`
			:host {
		...
		`],ni([eD(".control")],nn.prototype,"control",2),ni([eT({reflect:!0})],nn.prototype,"appearance",2),ni([eT({type:Boolean,reflect:!0})],nn.prototype,"disabled",2),ni([eT({reflect:!0})],nn.prototype,"density",2),ni([eT({type:Boolean,reflect:!0})],nn.prototype,"full",2),ni([eT()],nn.prototype,"href",2),ni([eT()],nn.prototype,"tooltip",2),ni([eT()],nn.prototype,"tooltipPlacement",2),ni([eT({type:Boolean,reflect:!0})],nn.prototype,"truncate",2),nn=ni([eB("gl-button")],nn);var ns=Object.defineProperty,na=Object.getOwnPropertyDescriptor,nl=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?na(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&ns(t,o,n),n};let nc=class extends lit_element_i{constructor(){super(...arguments),this.editor=!1,this.layout="shift",this.grouping="gap"}render(){return ew`<div class="group"><slot></slot></div>`}};nc.styles=[o1,E`
			:host {
	...
	`,ng([eT({reflect:!0})],nb.prototype,"icon",2),ng([eT({reflect:!0})],nb.prototype,"modifier",2),ng([eT({type:Number})],nb.prototype,"size",2),ng([eT({reflect:!0})],nb.prototype,"flip",2),ng([eT({reflect:!0})],nb.prototype,"rotate",2),nb=ng([eB("code-icon")],nb),i1.define("sl-popup");var nf=Object.defineProperty,nv=Object.getOwnPropertyDescriptor,ny=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nv(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&nf(t,o,n),n};let nw=class extends GlElement{constructor(){super(),this.placement="bottom",this.disabled=!1,this.distance=8,this.open=!1,this.arrow=!0,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleTriggerBlur=e=>{this.open&&this.hasTrigger("focus")&&(e.relatedTarget&&this.contains(e.relatedTarget)||this.hide())},this.handleTriggerClick=e=>{if(this.hasTrigger("click"))if(this.open&&"hover"!==this._triggeredBy){if(this._skipHideOnClick){this._skipHideOnClick=!1;return}if(e.composedPath().includes(this.body))return;this.hide()}else this.show("click")},this._skipHideOnClick=!1,this.handleTriggerMouseDown=()=>{this.hasTrigger("click")&&this.hasTrigger("focus")&&!this.matches(":focus-within")?this._skipHideOnClick=!0:this._skipHideOnClick=!1},this.handleTriggerFocus=()=>{this.hasTrigger("focus")&&(this.open&&"hover"!==this._triggeredBy&&!this.hasPopupFocus()?this.hide():this.show("focus"))},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handlePopupBlur=e=>{let t=e.composedPath();t.includes(this)||t.includes(this.body)||this.hide()},this.handleWebviewBlur=()=>{this.hide()},this.handleWebviewMouseDown=e=>{let t=e.composedPath();t.includes(this)||t.includes(this.body)||this.hide()},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let e=oE(getComputedStyle(this).getPropertyValue("--show-delay"));this.hoverTimeout=setTimeout(()=>this.show("hover"),e)}},this.handleMouseOut=e=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let t=e.composedPath();if(t[t.length-2]===this||this.hasPopupFocus()||"hover"!==this._triggeredBy)return;let o=oE(getComputedStyle(this).getPropertyValue("--hide-delay"));this.hoverTimeout=setTimeout(()=>this.hide(),o)}},this.addEventListener("blur",this.handleTriggerBlur,!0),this.addEventListener("focus",this.handleTriggerFocus,!0),this.addEventListener("click",this.handleTriggerClick),this.addEventListener("mousedown",this.handleTriggerMouseDown),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static closeOthers(e){for(let t of nw.openPopovers)t===e||t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_CONTAINS||t.hide()}get currentPlacement(){return this.popup?.getAttribute("data-current-placement")??this.placement}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleWebviewMouseDown),nw.openPopovers.delete(this),super.disconnectedCallback?.()}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}render(){return ew`<sl-popup
		...
		`],ny([eD("#popover")],nw.prototype,"body",2),ny([eD("sl-popup")],nw.prototype,"popup",2),ny([eT({reflect:!0})],nw.prototype,"placement",2),ny([eT({type:Object})],nw.prototype,"anchor",2),ny([eT({reflect:!0,type:Boolean})],nw.prototype,"disabled",2),ny([eT({type:Number})],nw.prototype,"distance",2),ny([eT({reflect:!0,type:Boolean})],nw.prototype,"open",2),ny([eT({reflect:!0,type:Boolean})],nw.prototype,"arrow",2),ny([eT({type:Number})],nw.prototype,"skidding",2),ny([eT()],nw.prototype,"trigger",2),ny([eT({type:Boolean})],nw.prototype,"hoist",2),ny([eT({reflect:!0})],nw.prototype,"appearance",2),ny([t2("open",{afterFirstUpdate:!0})],nw.prototype,"handleOpenChange",1),ny([t2(["distance","hoist","placement","skidding"])],nw.prototype,"handleOptionsChange",1),ny([t2("disabled")],nw.prototype,"handleDisabledChange",1),nw=ny([eB("gl-popover")],nw);var n_=Object.defineProperty,nk=Object.getOwnPropertyDescriptor,n$=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nk(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&n_(t,o,n),n};let nx=class extends lit_element_i{constructor(){super(...arguments),this._showUpgrade=!1}get showUpgrade(){return this._showUpgrade}set showUpgrade(e){this._showUpgrade=e}get accountAvatar(){return this.hasAccount&&this._state.avatar}get accountName(){return this.subscription?.account?.name??""}get accountEmail(){return this.subscription?.account?.email??""}get hasAccount(){return this.subscription?.account!=null}get isReactivatedTrial(){return this.subscriptionState===o7.Trial&&(this.subscription?.plan.effective.trialReactivationCount??0)>0}get planId(){return this._state.subscription?.plan.actual.id??"pro"}get effectivePlanId(){return this._state.subscription?.plan.effective.id??"pro"}get planName(){return function(e,t,o){switch(e){case o7.Community:case o7.Trial:return`${ri("pro")} Trial`;case o7.TrialExpired:case o7.TrialReactivationEligible:return ri("community-with-account");case o7.VerificationRequired:return`${ri(t??"pro")} (Unverified)`;default:return ri(t??"pro")}}(this.subscriptionState,this.planId,this.effectivePlanId)}get planTier(){return ra(this.subscription)?"Pro Trial":ro(this.planId)}get subscription(){return this._state.subscription}get subscriptionState(){return this.subscription?.state}get trialDaysRemaining(){return null==this.subscription?0:rn(this.subscription,"days")??0}focus(){this._chip.focus()}render(){return ew`<gl-popover placement="bottom" trigger="hover focus click" hoist>
			...
			${eN(rl(this.subscription.state),()=>{var e;return ew`<span class="row">
						<span class="row__media"><code-icon icon="unlock" size="20"></code-icon></span>
						<span class="details"
							><p class="details__title">
								${ra(this.subscription)?ew`${ro(this.effectivePlanId)} plan
											<span class="details__subtitle">(trial)</span>`:ew`${ro(this.planId)} plan`}
							</p></span
						>
						${rs(this.subscription)&&0>(e=this.planId,rr(e)-rr("advanced"))?ew`<div class="details__button">
									<gl-button
		...
		</div>`:e$}renderAccountState(){switch(this.subscriptionState){case o7.Paid:return ew`<div class="account-status">
					${this.renderIncludesDevEx()}${this.renderReferFriend()}
				</div> `;case o7.VerificationRequired:return ew`<div class="account-status">
				...
				</div>`;case o7.Trial:{let e=this.trialDaysRemaining;return ew`<div class="account-status">
				...
				</div>`}case o7.TrialExpired:return ew`<div class="account-status">
					...
					${this.renderPromo("pro")} ${this.renderIncludesDevEx()} ${this.renderReferFriend()}
				</div>`;case o7.TrialReactivationEligible:return ew`<div class="account-status">
					<p>
				...
				</div>`}}renderIncludesDevEx(){return ew`<p>Includes access to <a href="${t9.platform}">GitKraken's DevEx platform</a></p>`}renderReferFriend(){return rs(this.subscription)?ew`<p>
			<a
				href="${rc("gitlens.plus.referFriend",{source:"account"})}"
				>Refer a friend</a
			>
			&mdash; give 50% off and get up to $20
		</p>`:e$}renderUpgradeContent(){return rs(this.subscription)?(this.showUpgrade=!1,e$):(this.showUpgrade=!0,ew`<gl-popover placement="bottom" trigger="hover focus click" hoist>
		...
		></gl-promo>`}};nx.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},nx.styles=[o1,o2,o0,rd,rp,E`
			:host {
				display: inline-flex;
				align-items: center;
				gap: 0.8rem;
		...
		`],n$([eT({type:Boolean,reflect:!0,attribute:"show-upgrade"})],nx.prototype,"showUpgrade",1),n$([eD("#chip")],nx.prototype,"_chip",2),n$([eD("gl-popover")],nx.prototype,"_popover",2),n$([C({context:"state",subscribe:!0}),eL()],nx.prototype,"_state",2),n$([C({context:"promos"})],nx.prototype,"promos",2),nx=n$([eB("gl-account-chip")],nx);let private_async_helpers_s=class private_async_helpers_s{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}};let private_async_helpers_i=class private_async_helpers_i{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(e=>this.Z=e)}resume(){this.Z?.(),this.Y=this.Z=void 0}};let nC=e=>null!==e&&("object"==typeof e||"function"==typeof e)&&"function"==typeof e.then;let until_c=class until_c extends async_directive_f{constructor(){super(...arguments),this._$Cwt=0x3fffffff,this._$Cbt=[],this._$CK=new private_async_helpers_s(this),this._$CX=new private_async_helpers_i}render(...e){return e.find(e=>!nC(e))??ek}update(e,t){let o=this._$Cbt,r=o.length;this._$Cbt=t;let i=this._$CK,n=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){let a=t[e];if(!nC(a))return this._$Cwt=e,a;e<r&&a===o[e]||(this._$Cwt=0x3fffffff,r=0,Promise.resolve(a).then(async e=>{for(;n.get();)await n.get();let t=i.deref();if(void 0!==t){let o=t._$Cbt.indexOf(a);o>-1&&o<t._$Cwt&&(t._$Cwt=o,t.setValue(e))}}))}return ek}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};let nS=tN(until_c);var nP=Object.defineProperty,nO=Object.getOwnPropertyDescriptor,nA=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nO(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&nP(t,o,n),n};let nR=class extends lit_element_i{constructor(){super(...arguments),this.type="info",this._hasPromo=!1}get hasPromo(){return this._hasPromo}set hasPromo(e){this._hasPromo=e}render(){return ew`${nS(this.promoPromise?.then(e=>this.renderPromo(e)),e$)}`}renderPromo(e){if(!e?.content?.webview){this.hasPromo=!1;return}let t=e.content.webview;switch(this.type){case"icon":return ew`<code-icon icon="star-full" size="16"></code-icon>`;case"info":if(t.info)return this.hasPromo=!0,ew`<p class="promo" part="text">${rI(t.info.html)}</p>`;break;case"link":if(t.link)return this.hasPromo=!0,ew`<a
						class="link"
						part="link"
						href="${this.getCommandUrl(e)}"
						title="${t.link.title??e$}"
						>${rI(t.link.html)}</a
					>`}return this.hasPromo=!1,e$}getCommandUrl(e){let t;return e?.content?.webview?.link?.command?.startsWith("command:")&&(t=e.content.webview.link.command.substring(8)),rc(t??"gitlens.plus.upgrade",this.source)}focus(){this._focusable?.focus()}};nR.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},nR.styles=[E`
			:host {
				display: block;
			}
		...
		`],nA([eD('a,button,[tabindex="0"]')],nR.prototype,"_focusable",2),nA([eT({type:Object})],nR.prototype,"promoPromise",2),nA([eT({type:Object})],nR.prototype,"source",2),nA([eT({reflect:!0,type:String})],nR.prototype,"type",2),nA([eT({type:Boolean,reflect:!0,attribute:"has-promo"})],nR.prototype,"hasPromo",1),nR=nA([eB("gl-promo")],nR);var nI=Object.defineProperty,nB=Object.getOwnPropertyDescriptor,nE=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nB(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&nI(t,o,n),n};let nT=class extends lit_element_i{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:rn(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return ew`
		...
		`}renderBadge(){let e=this.preview?"Preview":"Pro";if(null!=this.subscription){if(this.state===o7.VerificationRequired)return ew`${e} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;else if(rs(this.subscription)||this.cloud&&null!=this.subscription.account)return ew`${e} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;else if(ra(this.subscription))return ew`${e} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}return e}renderPopoverHeader(){let e=ew`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===o7.Paid?ew`<div class="popup-header">${e}</div>`:this.cloud?this.preview?ew`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){let e;if(null==this.subscription)return e$;switch(this.state){case o7.Paid:e=ew`<p>
					Your
				...
				</p>`;break;case o7.VerificationRequired:e=ew`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							density="tight"
						...
						></gl-button>
					</div>`;break;case o7.Trial:{let t=this.daysRemaining;e=ew`<p>
						You have
						<strong>${t<1?"<1 day":op("day",t,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case o7.TrialExpired:e=ew`<p>
						Your Pro trial has ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(ew`<p>Please upgrade for full access to all GitLens Pro features:</p>`)}`;break;case o7.TrialReactivationEligible:e=ew`<p>
		...
		>
			...
			<span class="integration__content">
				...
				<span class="integration__details">${function(e){let t=e.supports.map(e=>nM.get(e));if(0===t.length)return"";if(1===t.length)return`Supports ${t[0]}`;let o=t.pop();return`Supports ${t.join(", ")}, and ${o}`}(e)}</span>
			</span>
		...
		</div>`}};nN.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},nN.styles=[o1,o2,rd,E`
			.chip {
				gap: 0.6rem;
		...
		`],nD([eD("#chip")],nN.prototype,"_chip",2),nD([C({context:"state",subscribe:!0}),eL()],nN.prototype,"_state",2),nN=nD([eB("gl-integrations-chip")],nN);let nM=new Map([["prs","pull requests"],["issues","issues"]]);var nj=Object.defineProperty,nF=Object.getOwnPropertyDescriptor,nq=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nF(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&nj(t,o,n),n};let nU=class extends lit_element_i{constructor(){super(...arguments),this.onDismissWalkthrough=()=>{this._state.walkthroughProgress=void 0,this._ipc.sendCommand(e2),this.requestUpdate()}}render(){if(null!=this._state.walkthroughProgress)return ew`<gl-button
			...
			</gl-tooltip>`}};nU.styles=[o8,o9],nq([C({context:"state",subscribe:!0}),eL()],nU.prototype,"_state",2),nq([C({context:"ipc",subscribe:!0}),eL()],nU.prototype,"_ipc",2),nU=nq([eB("gl-onboarding")],nU);var nW=Object.defineProperty,nH=Object.getOwnPropertyDescriptor,nG=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?nH(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&nW(t,o,n),n};let nV=class extends lit_element_i{render(){return ew`<gl-promo-banner></gl-promo-banner>
			<div class="container" tabindex="-1">
				<span class="group"><gl-account-chip></gl-account-chip></span>
				<gl-integrations-chip></gl-integrations-chip>
			</div>
			<gl-onboarding></gl-onboarding>`}show(){this.accountChip.show()}refreshPromo(){this.promoBanner?.requestUpdate()}};function nK(e,t,o,r){return`command:${e}?${encodeURIComponent(JSON.stringify({webview:t,webviewInstance:o,...r}))}`}nV.styles=[o1,o2,E`
			:host {
				display: block;
			}
		...
		>`}};function n5(e,t){return ew`<gl-branch-name .name=${e} .size=${12} ?worktree=${t??!1}></gl-branch-name>`}n2.styles=E`
		:host {
			display: inline-block;
			max-width: 100%;
	...
	`,n1([eT({type:String})],n2.prototype,"name",2),n1([eT({type:Number})],n2.prototype,"size",2),n1([eT({type:Boolean})],n2.prototype,"worktree",2),n2=n1([eB("gl-branch-name")],n2);var n8=Object.defineProperty,n6=Object.getOwnPropertyDescriptor,n4=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?n6(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&n8(t,o,n),n};let n3=class extends lit_element_i{render(){return this.name?ew`<gl-tooltip .content=${this.name}>${this.renderAvatar()}</gl-tooltip>`:this.renderAvatar()}renderAvatar(){return this.href?ew`<a href=${this.href} class="avatar">${this.renderContent()}</a>`:ew`<span class="avatar">${this.renderContent()}</span>`}renderContent(){return this.src?ew`<img class="thumb thumb--media" src="${this.src}" alt="${this.name}" />`:ew`<slot class="thumb thumb--text"></slot>`}};n3.styles=[E`
			:host {
				display: inline-block;
				vertical-align: middle;
			}
		...
		`],n4([eT()],n3.prototype,"src",2),n4([eT()],n3.prototype,"name",2),n4([eT()],n3.prototype,"href",2),n3=n4([eB("gl-avatar")],n3);var n9=Object.defineProperty,n7=Object.getOwnPropertyDescriptor,se=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?n7(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&n9(t,o,n),n};let st=class extends lit_element_i{constructor(){super(...arguments),this.max=3,this.avatars=[]}render(){return ew`<gl-avatar-group>${this.renderList()}</gl-avatar-group>`}renderList(){let e=this.avatars.slice(0,this.max),t=this.avatars.slice(this.max);return ew`
		...
		`}};se([eT({type:Number})],st.prototype,"max",2),se([eT({type:Array})],st.prototype,"avatars",2),st=se([eB("gl-avatar-list")],st);let so=class extends lit_element_i{render(){return ew`<slot class="avatar-group" part="base"></slot>`}};so.styles=[E`
			.avatar-group {
				display: inline-flex;
				flex-direction: row;
				justify-content: center;
		...
		`],so=se([eB("gl-avatar-group")],so);var sr=Object.defineProperty,si=Object.getOwnPropertyDescriptor,sn=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?si(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sr(t,o,n),n};let ss=Object.freeze([["added",["+","add"]],["modified",["~","edit"]],["removed",["-","trash"]]]),sa=class extends lit_element_i{constructor(){super(...arguments),this.added=0,this.modified=0,this.removed=0}render(){return ss.map(([e,t])=>this.renderStat(e,t))}renderStat(e,t){let o=this[e];return null==o?e$:ew`<span class="stat ${e}" aria-label="${o} ${e}"
			><span class="label">${this.renderSymbol(t)}${o}</span></span
		>`}renderSymbol([e,t]){return"icons"===this.symbol?ew`<code-icon class="icon" icon="${t}"></code-icon>`:ew`<span>${e}</span>`}};sa.styles=E`
		:host {
			display: inline-flex;
			flex-direction: row;
			align-items: center;
...
`;var su=Object.defineProperty,sg=Object.getOwnPropertyDescriptor,sm=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?sg(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&su(t,o,n),n};let sb=class extends lit_element_i{constructor(){super(...arguments),this.ahead=0,this.behind=0,this.working=0,this.alwaysShow=!1,this.outlined=!1,this.colorized=!1,this.missingUpstream=!1}render(){return 0===this.ahead&&0===this.behind&&0===this.working?this.alwaysShow?this.missingUpstream?ew`<span part="base" class="pill${this.outlined?" pill--outlined":""}">
		...
		`],sm([eT({type:Number})],sb.prototype,"ahead",2),sm([eT({type:Number})],sb.prototype,"behind",2),sm([eT({type:Number})],sb.prototype,"working",2),sm([eT({type:Boolean,attribute:"always-show"})],sb.prototype,"alwaysShow",2),sm([eT({type:Boolean})],sb.prototype,"outlined",2),sm([eT({type:Boolean})],sb.prototype,"colorized",2),sm([eT({type:Boolean})],sb.prototype,"missingUpstream",2),sb=sm([eB("gl-tracking-pill")],sb);let sf=E`
	.issue-icon--opened {
...
`;var sv=Object.defineProperty,sy=Object.getOwnPropertyDescriptor,sw=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?sy(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sv(t,o,n),n};let s_=class extends lit_element_i{get icon(){let e="issues";if(this.state)switch(this.state){case"opened":e="issues";break;case"closed":e="pass"}return e}get classes(){return this.state?`issue-icon issue-icon--${this.state}`:"issue-icon"}get label(){return this.state?`Issue ${this.issueId?`#${this.issueId}`:""} is ${this.state}`:"Issue"}render(){return this.state?ew`<gl-tooltip>
			...
			></code-icon>`}};s_.styles=[sf],sw([eT()],s_.prototype,"state",2),sw([eT({attribute:"issue-id"})],s_.prototype,"issueId",2),s_=sw([eB("issue-icon")],s_);let sk=E`
	.pr-icon--opened {
...
[${sA?"⌥":"Alt"}] ${this.altLabel}`:this.label}get effectiveLabel(){if(this.label||this.altLabel)return this.altLabel&&this.isAltKeyPressed?this.altLabel:this.label}get effectiveHref(){return this.isAltKeyPressed&&this.altHref?this.altHref:this.href}connectedCallback(){super.connectedCallback?.(),window.addEventListener("keydown",this),window.addEventListener("keyup",this)}disconnectedCallback(){super.disconnectedCallback?.(),window.removeEventListener("keydown",this),window.removeEventListener("keyup",this)}handleEvent(e){let t="Alt"===e.key||e.altKey;"keydown"===e.type?this.isAltKeyPressed=t:"keyup"===e.type&&t&&(this.isAltKeyPressed=!1)}render(){return ew`
		...
		`}focus(e){this.defaultFocusEl.focus(e)}};sE.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},sE.styles=E`
		:host {
			box-sizing: border-box;
			display: inline-flex;
			justify-content: center;
	...
	`,sB([eT()],sE.prototype,"href",2),sB([eT({attribute:"alt-href"})],sE.prototype,"altHref",2),sB([eT()],sE.prototype,"label",2),sB([eT({attribute:"alt-label"})],sE.prototype,"altLabel",2),sB([eT()],sE.prototype,"icon",2),sB([eT({attribute:"alt-icon"})],sE.prototype,"altIcon",2),sB([eT({type:Boolean})],sE.prototype,"disabled",2),sB([eD("a")],sE.prototype,"defaultFocusEl",2),sB([eL()],sE.prototype,"isAltKeyPressed",2),sE=sB([eB("action-item")],sE);var sT=Object.defineProperty,sL=Object.getOwnPropertyDescriptor,sz=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?sL(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sT(t,o,n),n};let sD=class extends lit_element_i{firstUpdated(){this.role="navigation"}disconnectedCallback(){this._slotSubscriptionsDisposer?.(),super.disconnectedCallback?.()}render(){return ew`<slot @slotchange=${this.handleSlotChange}></slot>`}handleSlotChange(e){if(this._slotSubscriptionsDisposer?.(),this.actionNodes.length<2)return;let t=this.handleKeydown.bind(this),o=`${this.actionNodes.length}`,r=this.actionNodes.map((e,r)=>(e.setAttribute("aria-posinset",`${r+1}`),e.setAttribute("aria-setsize",o),e.setAttribute("tabindex",0===r?"0":"-1"),e.addEventListener("keydown",t,!1),{dispose:()=>{e?.removeEventListener("keydown",t,!1)}}));this._slotSubscriptionsDisposer=()=>{r?.forEach(({dispose:e})=>e())}}handleKeydown(e){if(!e.target||null==this.actionNodes||this.actionNodes.length<2)return;let t=e.target,o=parseInt(t.getAttribute("aria-posinset")??"0",10),r=null;if("ArrowLeft"===e.key){let e=1===o?this.actionNodes.length-1:o-2;r=this.actionNodes[e]}else if("ArrowRight"===e.key){let e=o===this.actionNodes.length?0:o;r=this.actionNodes[e]}null!=r&&r!==t&&(t.setAttribute("tabindex","-1"),r.setAttribute("tabindex","0"),r.focus())}};sD.styles=E`
		:host {
			display: flex;
			align-items: center;
			user-select: none;
		}
	`,sz([(m={flatten:!0},(e,t)=>{let{slot:o,selector:r}=m??{},i="slot"+(o?`[name=${o}]`:":not([name])");return ez(e,t,{get(){let e=this.renderRoot?.querySelector(i),t=e?.assignedElements(m)??[];return void 0===r?t:t.filter(e=>e.matches(r))}})})],sD.prototype,"actionNodes",2),sD=sz([eB("action-nav")],sD);var sN=Object.defineProperty,sM=Object.getOwnPropertyDescriptor,sj=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?sM(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sN(t,o,n),n};let sF=class extends lit_element_i{constructor(){super(...arguments),this.hasChanges=!1,this.worktree=!1,this.isDefault=!1}render(){return ew`<gl-tooltip placement="bottom"
		...
		>`}renderIcon(){let e;if(!this.worktree&&(!this.status||"local"===this.status))return ew`<code-icon icon="git-branch"></code-icon>`;if("detached"===this.status)return ew`<code-icon icon="git-commit"></code-icon>`;let t="0.5";switch(this.status){case"diverged":e="var(--gl-icon-color-status-diverged)";break;case"behind":e="var(--gl-icon-color-status-behind)";break;case"ahead":e="var(--gl-icon-color-status-ahead)";break;case"missingUpstream":e="var(--gl-icon-color-status-missingUpstream)";break;case"upToDate":e=`var(--gl-icon-color-status-${this.hasChanges?"changes":"synced"})`;break;default:this.hasChanges?e="var(--gl-icon-color-status-changes)":(e="transparent",t="1")}return this.worktree&&!1===this.isDefault?e_`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16">
			...
			/>
				...
				<p>Has working (uncommitted) changes</p>`),e}};sF.styles=E`
		:host {
			display: inline-flex;
			width: 16px;
			height: 16px;
	...
	`,sj([eT({type:String})],sF.prototype,"branch",2),sj([eT({type:String})],sF.prototype,"status",2),sj([eT({type:Boolean})],sF.prototype,"hasChanges",2),sj([eT({type:String})],sF.prototype,"upstream",2),sj([eT({type:Boolean})],sF.prototype,"worktree",2),sj([eT({type:Boolean,attribute:"is-default"})],sF.prototype,"isDefault",2),sF=sj([eB("gl-branch-icon")],sF);let sq=E`
	:host {
		box-sizing: border-box;
		display: flex;
		align-items: center;
...
`;var sH=Object.defineProperty,sG=Object.getOwnPropertyDescriptor,sV=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?sG(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sH(t,o,n),n};let sK=class extends lit_element_i{constructor(){super(...arguments),this.icon=!1,this.size=13,this.worktree=!1}render(){let e,t;if(null==this.ref)return e$;switch(this.ref.refType){case"branch":e=this.worktree?"worktree":"branch",t=this.worktree?"gl-worktree":"git-branch";break;case"tag":e="tag",t="tag";break;default:e="revision",t="git-commit"}return ew`${this.icon?ew`<code-icon
						...
						icon="${t}"
						size="${this.size}"
					></code-icon>`:e$}<span class="label">${this.ref.name}</span>`}};sK.styles=E`
		:host {
			box-sizing: border-box;
			display: flex;
			align-content: center;
	...
	`,sV([eT({type:Boolean,reflect:!0})],sK.prototype,"icon",2),sV([eT({type:Object})],sK.prototype,"ref",2),sV([eT({type:Number})],sK.prototype,"size",2),sV([eT({type:Boolean})],sK.prototype,"worktree",2),sK=sV([eB("gl-ref-name")],sK);var sY=Object.defineProperty,sZ=Object.getOwnPropertyDescriptor,sJ=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?sZ(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sY(t,o,n),n};let sX=class extends lit_element_i{constructor(){super(...arguments),this.disabled=!1,this.icon=!1,this.size=16,this.worktree=!1}render(){return ew`<gl-button appearance="toolbar" href=${this.href??e$} ?disabled=${this.disabled}
		...
		`,sU],sJ([eT({type:Boolean,reflect:!0})],sX.prototype,"disabled",2),sJ([eT({type:String,reflect:!0})],sX.prototype,"href",2),sJ([eT({type:Boolean,reflect:!0})],sX.prototype,"icon",2),sJ([eT({type:Object})],sX.prototype,"ref",2),sJ([eT({type:Number})],sX.prototype,"size",2),sJ([eT({type:Boolean})],sX.prototype,"worktree",2),sX=sJ([eB("gl-ref-button")],sX);var sQ=Object.defineProperty,s0=Object.getOwnPropertyDescriptor,s1=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?s0(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&sQ(t,o,n),n};let s2=E`
	.header__actions {
		margin-top: 0.4rem;
	}
...
`,s5=class extends lit_element_i{get target(){return this._target}get targetPromise(){return this._targetPromise}set targetPromise(e){this._targetPromise!==e&&(this._targetPromise=e,this._targetPromise?.then(e=>this._target=e,()=>this._target=void 0))}get conflicts(){return this.target?.potentialConflicts}get mergedStatus(){return this.target?.mergedStatus}get status(){return this.target?.status}get branchRef(){if(null!=this.branch)return{repoPath:this.branch.repoPath,branchId:this.branch.id,branchName:this.branch.name,worktree:this.branch.worktree?{name:this.branch.worktree.name,isDefault:this.branch.worktree.isDefault}:void 0}}get targetBranchRef(){if(null!=this.target)return{repoPath:this.target.repoPath,branchId:this.target.id,branchName:this.target.name}}render(){let e,t;return this.status||this.conflicts?(this.mergedStatus?.merged?(e="git-merge",t="merged"):this.conflicts?(e="warning",t="conflict"):(this.status?.behind??0)>0?(e="arrow-down",t="behind"):(e="check",t="in-sync"),ew`<gl-popover placement="bottom" trigger="hover click focus" hoist>
			...
			<div slot="content" class="content">${this.renderContent()}</div>
		</gl-popover>`):e$}renderContent(){let e=n5(this.target?.name),t=this.mergedStatus?.merged&&this.mergedStatus.localBranchOnly?{repoPath:this.branch.repoPath,branchId:this.mergedStatus.localBranchOnly.id,branchName:this.mergedStatus.localBranchOnly.name,branchUpstreamName:this.mergedStatus.localBranchOnly.upstream?.name}:this.target?{repoPath:this.target.repoPath,branchId:this.target.id,branchName:this.target.name,branchUpstreamName:void 0}:void 0;return this.mergedStatus?.merged?this.mergedStatus.localBranchOnly?ew`${this.renderHeader(`Branch ${"highest"!==this.mergedStatus.confidence?"Likely ":""}Merged Locally into Merge Target`,"git-merge")}
					<div class="body">
						<p>
							Your current branch ${n5(this.branch.name)} has
							${"highest"!==this.mergedStatus.confidence?"likely ":""}been merged into its merge
							target's local branch ${n5(this.mergedStatus.localBranchOnly.name)}.
						</p>
						<div class="button-container">
							<gl-button
								full
								href="${rc("gitlens.home.pushBranch",t)}"
								>Push ${n5(this.mergedStatus.localBranchOnly.name)}</gl-button
							>
							<gl-button
								full
								appearance="secondary"
								...
								${n5(this.branch.name,null!=this.branch.worktree)}</gl-button
							>
						</div>
				...
				<div class="body">
					${this.status?ew`<p>
								Your current branch ${n5(this.branch.name)} is
					...
					<div class="button-container">
						<gl-button
							...
							>Rebase ${n5(this.conflicts.branch)} onto ${e}</gl-button
						>
						<gl-button
							full
							appearance="secondary"
							href="${rc("gitlens.home.mergeIntoCurrent",this.targetBranchRef)}"
							>Merge ${e} into ${n5(this.conflicts.branch)}</gl-button
						>
					</div>
				...
				</div>`:null!=this.status?this.status.behind>0?ew`${this.renderHeader(`${op("Commit",this.status.behind)} Behind Merge Target`,"arrow-down","warning")}
					<div class="body">
						<p>
							Your current branch ${n5(this.branch.name)} is
							${op("commit",this.status.behind)} behind its merge target
						...
						<div class="button-container">
							<gl-button
								full
								href="${rc("gitlens.home.rebaseCurrentOnto",this.targetBranchRef)}"
								>Rebase ${n5(this.branch.name)} onto ${e}</gl-button
							>
							<gl-button
								full
								appearance="secondary"
								href="${rc("gitlens.home.mergeIntoCurrent",this.targetBranchRef)}"
								>Merge ${e} into ${n5(this.branch.name)}</gl-button
							>
						</div>
				...
				<div class="body">
					<p>
						Your current branch ${n5(this.branch.name)} is up to date with its merge target
						${this.renderInlineTargetEdit(this.target)}.
					</p>
			...
			<gl-tooltip class="header__title">
				...
				<span slot="content"
					>${e}
					<p>
						The "merge target" is the branch that ${n5(this.branch.name)} is most likely to be
						merged into.
					</p>
				</span>
			</gl-tooltip>
			...
			>${e&&t?ew`<gl-button
							...
							><span slot="tooltip"
								>Change Merge Target<br />${n5(this.target?.name)}</span
							></gl-button
						><gl-button
							...
							<span slot="tooltip"
								>Compare Branch with Merge Target<br />${n5(this.branch.name)}
								<code-icon icon="arrow-both" size="12"></code-icon> ${n5(this.target?.name)}</span
							>
						</gl-button>`:e$}<gl-button
				href="${rc("gitlens.home.fetch",this.targetBranchRef)}"
				appearance="toolbar"
				><code-icon icon="repo-fetch"></code-icon>
				<span slot="tooltip">Fetch Merge Target<br />${n5(this.target?.name)}</span>
			</gl-button></span
		...
		`}renderFile(e){return ew`<span class="files__item"><code-icon icon="file"></code-icon> ${e}</span>`}};s5.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},s5.styles=[o1,o2,rd,o5,s2],s1([eT({type:Object})],s5.prototype,"branch",2),s1([eL()],s5.prototype,"_target",2),s1([eT({type:Object})],s5.prototype,"targetPromise",1),s5=s1([eB("gl-merge-target-status")],s5);let s8=class extends lit_element_i{render(){let e="upgrade";return ew`<gl-popover placement="bottom" trigger="hover click focus" hoist>
		...
		</gl-popover>`}};s8.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},s8.styles=[o1,o2,rd,o5,s2],s8=s1([eB("gl-merge-target-upgrade")],s8);var s6=Object.defineProperty,s4=Object.getOwnPropertyDescriptor,s3=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?s4(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&s6(t,o,n),n};let s9=E`
	* {
		box-sizing: border-box;
	}
...
`;let GlBranchCardBase=class GlBranchCardBase extends GlElement{constructor(){super(...arguments),this.showUpgrade=!1,this.busy=!1,this.expanded=!1,this.expandable=!1,this.onFocus=e=>{e.composedPath().some(e=>e.matches?.("action-item")??!1)||this.expanded||this.toggleExpanded(!0)}}static{this.styles=[rh,s9]}get branch(){return this._branch}set branch(e){this._branch=e,this.autolinksPromise=e?.autolinks,this.contributorsPromise=e?.contributors,this.issuesPromise=e?.issues,this.prPromise=e?.pr,this.mergeTargetPromise=e?.mergeTarget,this.remotePromise=e?.remote,this.wipPromise=e?.wip}get autolinks(){return this._autolinks}get autolinksPromise(){return this._autolinksPromise}set autolinksPromise(e){this._autolinksPromise!==e&&(this._autolinksPromise=e,this._autolinksPromise?.then(e=>this._autolinks=e,()=>this._autolinks=void 0))}get contributors(){return this._contributors}get contributorsPromise(){return this._contributorsPromise}set contributorsPromise(e){this._contributorsPromise!==e&&(this._contributorsPromise=e,this._contributorsPromise?.then(e=>this._contributors=e,()=>this._contributors=void 0))}get issues(){return this._issues}get issuesPromise(){return this._issuesPromise}set issuesPromise(e){this._issuesPromise!==e&&(this._issuesPromise=e,this._issuesPromise?.then(e=>this._issues=e,()=>this._issues=void 0))}get pr(){return this._pr}get prPromise(){return this._prPromise}set prPromise(e){this._prPromise!==e&&(this._prPromise=e,this._prPromise?.then(e=>{this._pr=e,this.launchpadItemPromise=e?.launchpad},()=>{this._pr=void 0,this.launchpadItemPromise=void 0}))}get launchpadItem(){return this._launchpadItem}get launchpadItemPromise(){return this._launchpadItemPromise}set launchpadItemPromise(e){this._launchpadItemPromise!==e&&(this._launchpadItemPromise=e,this._launchpadItemPromise?.then(e=>this._launchpadItem=e,()=>this._launchpadItem=void 0))}get mergeTarget(){return this._mergeTarget}get mergeTargetPromise(){return this._mergeTargetPromise}set mergeTargetPromise(e){this._mergeTargetPromise!==e&&(this._mergeTargetPromise=e,this._mergeTargetPromise?.then(e=>this._mergeTarget=e,()=>this._mergeTarget=void 0))}get remote(){return this._remote}get remotePromise(){return this._remotePromise}set remotePromise(e){this._remotePromise!==e&&(this._remotePromise=e,this._remotePromise?.then(e=>this._remote=e,()=>this._remote=void 0))}get wip(){return this._wip}get wipPromise(){return this._wipPromise}set wipPromise(e){this._wipPromise!==e&&(this._wipPromise=e,this._wipPromise?.then(e=>this._wip=e,()=>this._wip=void 0))}onExpandableChanged(){this.attachFocusListener()}get branchRef(){return{repoPath:this.repo,branchId:this.branch.id,branchName:this.branch.name,worktree:this.branch.worktree?{name:this.branch.worktree.name,isDefault:this.branch.worktree.isDefault}:void 0}}get isWorktree(){return null!=this.branch.worktree&&!this.branch.worktree.isDefault}get cardIndicator(){return ao(at(this.pr,this.launchpadItem))??"base"}get branchCardIndicator(){if(this.branch.opened){if(this.wip?.pausedOpStatus!=null){if(this.wip?.hasConflicts)return"conflict";switch(this.wip.pausedOpStatus.type){case"cherry-pick":return"cherry-picking";case"merge":return"merging";case"rebase":return"rebasing";case"revert":return"reverting"}}if(this.wip?.workingTreeState!=null&&this.wip.workingTreeState.added+this.wip.workingTreeState.changed+this.wip.workingTreeState.deleted>0)return"branch-changes";if(this.mergeTarget?.mergedStatus?.merged)return"branch-merged";switch(this.branch.status){case"ahead":return"branch-ahead";case"behind":return"branch-behind";case"diverged":return"branch-diverged";case"upToDate":return"branch-synced";case"missingUpstream":return"branch-missingUpstream";default:return}}}connectedCallback(){super.connectedCallback?.(),this.attachFocusListener()}disconnectedCallback(){super.disconnectedCallback?.(),this.eventController?.abort()}attachFocusListener(){this.eventController?.abort(),this.eventController=void 0,this.expandable&&(null==this.eventController&&(this.eventController=new AbortController),this.addEventListener("focusin",this.onFocus,{signal:this.eventController.signal}))}renderIssues(){let{autolinks:e,issues:t}=this,o=t?.length?t:e;return o?.length?ew`
			${o.map(e=>ew`
				...
				`)}
		`:e$}renderWip(){let e=this.wip?.workingTreeState;if(null==e)return e$;let t=ar(e);return ew`<gl-tooltip class="wip__pill" placement="bottom"
			><commit-stats
				added=${e.added}
				modified=${e.changed}
				removed=${e.deleted}
			...
			max="1"
		></gl-avatar-list>`:e$}renderTracking(e=!1){let t,o;if(null==this.branch.upstream)return e$;let{state:r}=this.branch.upstream,i=0;if(e){let e=this.wip?.workingTreeState;if(null!=e){i=e.added+e.changed+e.deleted;let o=ar(e);o.length&&(t=ew`<p class="tracking__tooltip--wip">${o.join(", ")} in the working tree</p>`)}}if(this.branch.upstream.missing)o=ew`${n5(this.branch.name)} is missing its upstream
			${n5(this.branch.upstream.name)}`;else{let e=[];r.behind&&e.push(`${op("commit",r.behind)} behind`),r.ahead&&e.push(`${op("commit",r.ahead)} ahead of`),o=e.length?ew`${n5(this.branch.name)} is
				${e.join(", ")}${n5(this.branch.upstream?.name)}`:ew`${n5(this.branch.name)} is up to date with
				${n5(this.branch.upstream?.name)}`}return ew`<gl-tooltip class="tracking__pill" placement="bottom"
			><gl-tracking-pill
				class="pill"
				colorized
				outlined
		...
		></gl-branch-icon>`}renderPrItem(){if(!this.pr)return this.branch.upstream?.missing===!1&&this.expanded?ew`
				...
				`:e$;let e=this.branch.opened?ao(at(this.pr,this.launchpadItem))??"base":void 0,t=this.renderPrActions();return ew`
		...
		`}renderLaunchpadItem(){if(null==this.launchpadItem)return e$;let e=at(this.pr,this.launchpadItem);if(null==e)return e$;let t=nZ.get(e),o=nY.get(e);if(null==t||null==o)return e$;let r=o.match(/\$\((.*?)\)/)[1].replace("gitlens","gl"),i=function(e,t){if(null==e||0===e.length)return e;if(null==t)return e.replace(oc,"");let o=function(e){let t=od.get(e);if(null!=t)return t;t=[];let o=e.length,r=0;for(;r<o;){let o=e.indexOf("${",r);if(-1===o)break;let i=e.indexOf("}",o);if(-1===i)break;let n=o+2,a="",l="",c="",d=!1,h="right",p="";if("'"===e[n]){let t=++n;if(-1===(n=e.indexOf("'",n)))break;t!==n&&(l=e.slice(t,n)),n++}else if(!oh(e.charCodeAt(n))){let t=n++;for(;n<i&&!oh(e.charCodeAt(n));)n++;t!==n&&(l=e.slice(t,n))}for(;n<i;){let t=e.charCodeAt(n);if(oh(t))a+=e[n++];else{if(124!==t)break;for(;n<i;){if((t=e.charCodeAt(++n))>=48&&t<=57){c+=e[n];continue}63===t?(d=!0,n++):45===t&&(h="left",n++);break}}}if(n<i){if("'"===e[n]){let t=++n;if(-1===(n=e.indexOf("'",n)))break;t!==n&&(p=e.slice(t,n)),n++}else if(!oh(e.charCodeAt(n))){let t=n++;for(;n<i&&!oh(e.charCodeAt(n));)n++;t!==n&&(p=e.slice(t,n))}}r=i+1,t.push({key:a,start:o,end:r,options:{prefix:l||void 0,suffix:p||void 0,truncateTo:c?parseInt(c,10):void 0,collapseWhitespace:d,padDirection:h}})}return od.set(e,t),t}(e);if(0===o.length)return e;let r=0,i="";for(let n of o)i+=e.slice(r,n.start)+(t[n.key]??""),r=n.end;return r<e.length&&(i+=e.slice(r)),i}(nX.get(this.launchpadItem.category)[1],{author:this.launchpadItem.author?.username??"unknown",createdDateRelative:oi(new Date(this.launchpadItem.createdDate))});return ew`<div class="branch-item__section branch-item__section--details" slot="context">
			...
			${r?ew`<span
						class="branch-item__summary launchpad-grouping--${ao(e)}"
						slot="summary"
		...
		`}toggleExpanded(e=!this.expanded){this.expanded=e,queueMicrotask(()=>{this.emit("gl-branch-card-expand-toggled",{expanded:e})})}};s3([C({context:"state",subscribe:!0}),eL()],GlBranchCardBase.prototype,"_homeState",2),s3([eT()],GlBranchCardBase.prototype,"repo",2),s3([eT({type:Boolean})],GlBranchCardBase.prototype,"showUpgrade",2),s3([eT({type:Object})],GlBranchCardBase.prototype,"branch",1),s3([eL()],GlBranchCardBase.prototype,"_autolinks",2),s3([eL()],GlBranchCardBase.prototype,"_contributors",2),s3([eL()],GlBranchCardBase.prototype,"_issues",2),s3([eL()],GlBranchCardBase.prototype,"_pr",2),s3([eL()],GlBranchCardBase.prototype,"_launchpadItem",2),s3([eL()],GlBranchCardBase.prototype,"_mergeTarget",2),s3([eL()],GlBranchCardBase.prototype,"_remote",2),s3([eL()],GlBranchCardBase.prototype,"_wip",2),s3([eT({type:Boolean,reflect:!0})],GlBranchCardBase.prototype,"busy",2),s3([eT({type:Boolean,reflect:!0})],GlBranchCardBase.prototype,"expanded",2),s3([eT({type:Boolean,reflect:!0})],GlBranchCardBase.prototype,"expandable",2),s3([t2("expandable")],GlBranchCardBase.prototype,"onExpandableChanged",1);let s7=class extends GlBranchCardBase{render(){return ew`
		...
		`}getCollapsedActions(){let e=[];return this.isWorktree?e.push(ew`<action-item
			...
			></action-item>`]}renderBranchIndicator(){}};s7=s3([eB("gl-branch-card")],s7);let ae=class extends lit_element_i{constructor(){super(...arguments),this.primary=!1,this.nested=!1,this.expanded=!1}render(){return ew`<gl-card
		...
		>`}renderContent(){let e=this.querySelectorAll('[slot="context"]').length>0||this.querySelectorAll('[slot="actions"]').length>0;return ew`
			<div class=${iX({"work-item":!0,"work-item_content-empty":!e})}>
		...
		`}renderSummary(){return this.expanded?e$:ew`<slot class="work-item__summary" name="summary"></slot>`}};function at(e,t){if(null==t||e?.state!=="opened"||e.draft&&"unassigned-reviewers"===t.category)return;let o=nJ.get(t.category);if(null!=o&&"other"!==o&&"draft"!==o&&"current-branch"!==o)return o}function ao(e){switch(e){case"mergeable":return"mergeable";case"blocked":return"blocked";case"follow-up":case"needs-review":return"attention"}}function ar(e){let t=[];return e.added&&t.push(`${op("file",e.added??0)} added`),e.changed&&t.push(`${op("file",e.changed??0)} changed`),e.deleted&&t.push(`${op("file",e.deleted??0)} deleted`),t}ae.styles=[E`
			.work-item {
				display: flex;
				flex-direction: column;
				gap: 0.8rem;
		...
		`],s3([eT({type:Boolean,reflect:!0})],ae.prototype,"primary",2),s3([eT({type:Boolean,reflect:!0})],ae.prototype,"nested",2),s3([eT({reflect:!0})],ae.prototype,"indicator",2),s3([eT({type:Boolean,reflect:!0})],ae.prototype,"expanded",2),ae=s3([eB("gl-work-item")],ae);var ai=Object.defineProperty,an=Object.getOwnPropertyDescriptor,as=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?an(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&ai(t,o,n),n};let aa=class extends lit_element_i{render(){return ew`<slot></slot>`}};aa.styles=E`
		* {
			box-sizing: border-box;
		}
	...
	`,aa=as([eB("gl-breadcrumbs")],aa);let al=class extends lit_element_i{constructor(){super(...arguments),this.collapsibleState="none",this._shrink=1,this.onToggleCollapse=e=>{e.preventDefault(),e.stopPropagation(),e instanceof KeyboardEvent&&"Enter"!==e.key&&" "!==e.key||(this.collapsed=!this.collapsed)}}get collapsed(){return this._collapsed??"collapsed"===this.collapsibleState}set collapsed(e){this._collapsed=e}get collapsible(){return"none"!==this.collapsibleState}get shrink(){return this._shrink}set shrink(e){let t=this._shrink;this._shrink=e,this.style.setProperty("--gl-breadcrumb-item-shrink",String(e)),this.requestUpdate("shrink",t)}render(){let{collapsed:e,collapsible:t}=this;return ew`<div class=${iX({"breadcrumb-item":!0,collapsible:t})}>
		...
		>
			...
			></code-icon>
		</gl-tooltip>`:ew`<code-icon class="breadcrumb-icon" icon="${this.icon}"></code-icon>`:e$}};al.styles=[o0,E`
			* {
				box-sizing: border-box;
			}
		...
		`],as([eL()],al.prototype,"_collapsed",2),as([eT({type:Boolean,reflect:!0})],al.prototype,"collapsed",1),as([eT({type:String})],al.prototype,"collapsibleState",2),as([eT()],al.prototype,"icon",2),as([eT()],al.prototype,"iconTooltip",2),as([eT({type:Number})],al.prototype,"shrink",1),al=as([eB("gl-breadcrumb-item")],al);let ac=class extends lit_element_i{render(){return ew`<slot></slot>`}};ac.styles=E`
		:host {
			display: flex;
			flex-direction: row;
			align-items: center;
	...
	`,ac=as([eB("gl-breadcrumb-item-child")],ac);var ad=Object.defineProperty,ah=Object.getOwnPropertyDescriptor,ap=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?ah(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&ad(t,o,n),n};let au=class extends lit_element_i{constructor(){super(...arguments),this.lines=1}render(){let e=`--skeleton-lines: ${this.lines};`;return ew`<div class="skeleton" style=${e}></div>`}};au.styles=E`
		:host {
	...
	`,ap([eT({type:Number})],au.prototype,"lines",2),au=ap([eB("skeleton-loader")],au);let ag=E`
	:host {
...
`;var am=Object.defineProperty,ab=Object.getOwnPropertyDescriptor,af=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?ab(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&am(t,o,n),n};let av=class extends lit_element_i{constructor(){super(...arguments),this._focusable=!1}get focusable(){return null!=this.href||this._focusable}set focusable(e){let t=this._focusable;this._focusable=e,this.requestUpdate("focusable",t)}get classNames(){return{card:!0,"card--focusable":this.focusable,[`card--grouping-${this.grouping}`]:null!=this.grouping,[`card--density-${this.density}`]:null!=this.density,[`is-${this.indicator}`]:null!=this.indicator}}render(){return null!=this.href?ew`<a part="base" class=${iX(this.classNames)} href=${this.href}
				>${this.renderContent()}</a
			>`:ew`<div part="base" tabindex=${this.focusable?0:-1} class=${iX(this.classNames)}>
			${this.renderContent()}
		</div>`}renderContent(){return ew`
			<slot class="card__content"></slot>
			<slot name="actions" class="card__actions"></slot>
		`}focus(e){null!=this.href?this.shadowRoot?.querySelector("a")?.focus(e):super.focus(e)}};av.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},av.styles=[ag],af([eT({reflect:!0})],av.prototype,"indicator",2),af([eT({reflect:!0})],av.prototype,"grouping",2),af([eT({reflect:!0})],av.prototype,"density",2),af([eT()],av.prototype,"href",2),af([eT({type:Boolean,reflect:!0})],av.prototype,"focusable",1),av=af([eB("gl-card")],av);var ay=Object.defineProperty,aw=Object.getOwnPropertyDescriptor;let a_=class extends lit_element_i{};a_.styles=[o1,E`
			:host {
				display: block;
				height: 0;
				margin: 0.6rem;
		...
		`],ax([eT({type:Boolean,reflect:!0})],aC.prototype,"disabled",2),ax([eT({reflect:!0})],aC.prototype,"href",2),ax([eT({reflect:!0})],aC.prototype,"role",2),aC=ax([eB("menu-item")],aC);var aS=Object.defineProperty,aP=Object.getOwnPropertyDescriptor;let aO=class extends lit_element_i{render(){return ew`<slot></slot>`}};aO.styles=[o1,E`
			:host {
				display: block;
				text-transform: uppercase;
				font-size: 0.84em;
		...
		`],aO=((e,t,o,r)=>{for(var i,n=r>1?void 0:r?aP(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&aS(t,o,n),n})([eB("menu-label")],aO);let aA=E`
	/*
	:host {
		display: inline-block;
	}
...
`;var aI=Object.defineProperty,aB=Object.getOwnPropertyDescriptor,aE=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?aB(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&aI(t,o,n),n};let aT=class extends lit_element_i{constructor(){super(...arguments),this.pulse=!1}render(){return ew`<slot class="indicator${this.pulse?" indicator--pulse":""}"></slot>`}};aT.styles=[aA,aR],aE([eT({type:Boolean})],aT.prototype,"pulse",2),aT=aE([eB("gl-indicator")],aT);var aL=Object.defineProperty,az=Object.getOwnPropertyDescriptor,aD=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?az(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&aL(t,o,n),n};let aN=class extends GlElement{constructor(){super(...arguments),this.connectIcon=!0,this.disabled=!1,this.icon=!0,this.hasMultipleRepositories=!1,this.expandable=!1}get icons(){if(this.repository?.provider===void 0)return;let e=0;if(this.icon&&e++,this.connectIcon&&this.repository.provider.integration?.connected===!1&&e++,0!==e)return e}get displayName(){return this.repository?.name??"none selected"}render(){return ew`
		...
		`,sU],aD([eT({type:Boolean})],aN.prototype,"connectIcon",2),aD([eT({type:Boolean})],aN.prototype,"disabled",2),aD([eT({type:Boolean})],aN.prototype,"icon",2),aD([eT({type:Object})],aN.prototype,"repository",2),aD([eT({type:Boolean})],aN.prototype,"hasMultipleRepositories",2),aD([eT({type:Object})],aN.prototype,"source",2),aD([eT({type:Boolean,reflect:!0})],aN.prototype,"expandable",2),aD([eT({type:Number,reflect:!0})],aN.prototype,"icons",1),aN=aD([eB("gl-repo-button-group")],aN);let aM={"cherry-pick":{label:"Cherry picking",conflicts:"Resolve conflicts to continue cherry picking",directionality:"into"},merge:{label:"Merging",conflicts:"Resolve conflicts to continue merging",directionality:"into"},rebase:{label:"Rebasing",conflicts:"Resolve conflicts to continue rebasing",directionality:"onto",pending:"Pending rebase of"},revert:{label:"Reverting",conflicts:"Resolve conflicts to continue reverting",directionality:"in"}};function aj(e){return e.startsWith("remotes/")?e.indexOf("/",8):e.indexOf("/")}let aF=/^([\w\-/]+(?:\.[\w\-/]+)*)?(\.\.\.?)([\w\-/]+(?:\.[\w\-/]+)*)?$/,aq=/^([\w\-/]+(?:\.[\w\-/]+)*)(\.\.\.?)([\w\-/]+(?:\.[\w\-/]+)*)$/,aU=/^([\w\-/]+(?:\.[\w\-/]+)*)(\.\.)([\w\-/]+(?:\.[\w\-/]+)*)$/,aW=/^([\w\-/]+(?:\.[\w\-/]+)*)(\.\.\.)([\w\-/]+(?:\.[\w\-/]+)*)$/,aH=/(^[0-9a-f]{40})\^[0-3]?$/;function aG(e,t){var o,r,i,n;let a;if(null==e)return"";t=!1===t?{}:{expand:!0,icon:!0,label:t?.label??t?.expand??!0,...t};let l=t?.quoted?`'${e.name}'`:e.name;switch(e.refType){case"branch":{let i;e.remote&&(l=`${(o=l).substring(0,aj(o))}: ${(r=l).substring(aj(r)+1)}`,l=t?.quoted?`'${l}'`:l),i=t.label?t.capitalize&&t.expand?`${e.remote?"Remote ":""}Branch `:`${e.remote?"remote ":""}branch `:"",a=`${i}${t.icon?`$(git-branch)${t6.Space}${l}`:l}`;break}case"tag":a=`${t.label?"tag ":""}${t.icon?`$(tag)${t6.Space}${l}`:l}`;break;default:if(e?.refType==="stash"||e?.refType==="revision"&&e?.stashName){let o;t.expand&&e.message&&(o=`${null!=e.stashNumber?`#${e.stashNumber}: `:""}${e.message.length>20?`${e.message.substring(0,20).trimEnd()}${t6.Ellipsis}`:e.message}`),a=`${t.label?"stash ":""}${t.icon?`$(archive)${t6.Space}${o??e.name}`:o??(e.stashNumber?`#${e.stashNumber}`:e.name)}`}else if(function(e,t="any"){if(null==e)return!1;switch(t){case"qualified":return aq.test(e);case"qualified-double-dot":return aU.test(e);case"qualified-triple-dot":return aW.test(e);default:return aF.test(e)}}(e.ref))a=l;else{let o,r;(t.expand&&e.message&&(o=e.message.length>20?` (${e.message.substring(0,20).trimEnd()}${t6.Ellipsis})`:` (${e.message})`),t.expand&&t.label&&(i=e.ref,i&&aH.test(i)))?(l=e.name.endsWith("^")?e.name.substring(0,e.name.length-1):e.name,t?.quoted&&(l=`'${l}'`),r="before "):r="",a=`${t.label?`${r}commit `:""}${t.icon?`$(git-commit)${t6.Space}${l}${o??""}`:`${l}${o??""}`}`}}return t.capitalize&&t.expand&&!1!==t.label?(n=a,`${n[0].toLocaleUpperCase()}${n.slice(1)}`):a}var aV=Object.defineProperty,aK=Object.getOwnPropertyDescriptor,aY=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?aK(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&aV(t,o,n),n};let aZ=class extends lit_element_i{constructor(){super(...arguments),this.conflicts=!1,this.skipCommand="gitlens.home.skipPausedOperation",this.continueCommand="gitlens.home.continuePausedOperation",this.abortCommand="gitlens.home.abortPausedOperation",this.openEditorCommand="gitlens.home.openRebaseEditor"}get onSkipUrl(){return this.createCommandLink(this.skipCommand,this.pausedOpStatus)}get onContinueUrl(){return this.createCommandLink(this.continueCommand,this.pausedOpStatus)}get onAbortUrl(){return this.createCommandLink(this.abortCommand,this.pausedOpStatus)}get onOpenEditorUrl(){return this.createCommandLink(this.openEditorCommand,this.pausedOpStatus)}createCommandLink(e,t){return null!=this.webviewCommandContext&&(t=null==t?this.webviewCommandContext:{...t,...this.webviewCommandContext}),rc(e,t)}render(){return null==this.pausedOpStatus?e$:ew`
		...
		`}renderStatus(e){if("rebase"!==e.type){let t=aM[e.type];return ew`<span class="label"
				>${this.conflicts?t.conflicts:t.label}
				<code-icon
					icon="${"branch"===e.incoming.refType?"git-branch":"git-commit"}"
					class="icon"
				></code-icon>
				${aG(e.incoming,{expand:!1,icon:!1})} ${t.directionality}
				${aG(e.current,{expand:!1,icon:!1})}</span
			>`}let t=e.steps.total>0,o=aM[e.type];return ew`<span class="label"
				>${this.conflicts?o.conflicts:t?o.label:o.pending}
				<code-icon
					icon="${"branch"===e.incoming.refType?"git-branch":"git-commit"}"
					class="icon"
				></code-icon>
				${aG(e.incoming,{expand:!1,icon:!1})} ${o.directionality}
				${aG(e.current??e.onto,{expand:!1,icon:!1})}</span
		...
		`],aY([eT({type:Boolean,reflect:!0})],aZ.prototype,"conflicts",2),aY([eT({type:Object})],aZ.prototype,"pausedOpStatus",2),aY([eT()],aZ.prototype,"skipCommand",2),aY([eT()],aZ.prototype,"continueCommand",2),aY([eT()],aZ.prototype,"abortCommand",2),aY([eT()],aZ.prototype,"openEditorCommand",2),aY([eT({type:Object})],aZ.prototype,"webviewCommandContext",2),aZ=aY([eB("gl-merge-rebase-status")],aZ);var aJ=Object.defineProperty,aX=Object.getOwnPropertyDescriptor,aQ=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?aX(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&aJ(t,o,n),n};let a0=class extends tD(lit_element_i){constructor(){super(...arguments),this.repoCollapsed=!0}get isPro(){return rl(this._homeState.subscription.state)}connectedCallback(){super.connectedCallback?.(),this._homeState.repositories.openCount>0&&this._activeOverviewState.run()}onBranchSelectorClicked(){this._ipc.sendCommand(eF,{command:"gitlens.home.switchToBranch",args:[{repoPath:this._activeOverviewState.state?.active.repoPath}]})}render(){return this._homeState.discovering?this.renderLoader():0===this._homeState.repositories.openCount?e$:this._activeOverviewState.render({pending:()=>this.renderPending(),complete:e=>this.renderComplete(e),error:()=>ew`<span>Error</span>`})}renderLoader(){return ew`
			<gl-section>
		...
		></gl-active-branch-card>`}onRepositorySelectorClicked(e){"label"===e.detail.part&&this._activeOverviewState.changeRepository()}};a0.styles=[rh,s9,rp,E`
			[hidden] {
				display: none;
			}
		...
		`],aQ([C({context:"state",subscribe:!0}),eL()],a0.prototype,"_homeState",2),aQ([C({context:"activeOverviewState"})],a0.prototype,"_activeOverviewState",2),aQ([C({context:"ipc"})],a0.prototype,"_ipc",2),aQ([eL()],a0.prototype,"repoCollapsed",2),a0=aQ([eB("gl-active-work")],a0);let a1=class extends GlBranchCardBase{connectedCallback(){super.connectedCallback?.(),this.toggleExpanded(!0)}render(){return ew`
		...
		>
			...
			`),r();if(t?.state?.ahead||t?.state?.behind){let e=!!t.state.ahead,n=!!t.state.behind;if(e&&n)return o.push(ew`
					<gl-button
						aria-busy=${i??e$}
						?disabled=${i}
						href=${nK("gitlens.views.home.pull","gitlens.views.home","")}
						appearance="secondary"
						density="compact"
					>
					...
					<gl-button
						aria-busy=${i??e$}
						?disabled=${i}
						href=${nK("gitlens.views.home.push","gitlens.views.home","",{force:!0})}
						appearance="secondary"
						density="compact"
					>
				...
				`),r();e&&o.push(ew`
					<gl-button
						aria-busy=${i??e$}
						?disabled=${i}
						href=${nK("gitlens.views.home.push","gitlens.views.home","")}
						appearance="secondary"
						density="compact"
					>
		...
		`],a1=aQ([eB("gl-active-branch-card")],a1);var a2=Object.defineProperty,a5=Object.getOwnPropertyDescriptor,a8=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?a5(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&a2(t,o,n),n};let a6=class extends lit_element_i{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return ew`<div class="progress-bar"></div>`}};a6.styles=E`
		* {
			box-sizing: border-box;
		}
	...
	`,a8([eT({reflect:!0})],a6.prototype,"mode",2),a8([eT({type:Boolean})],a6.prototype,"active",2),a8([eT()],a6.prototype,"position",2),a6=a8([eB("progress-indicator")],a6);var a4=Object.defineProperty,a3=Object.getOwnPropertyDescriptor,a9=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?a3(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&a4(t,o,n),n};let a7=class extends lit_element_i{constructor(){super(...arguments),this.loading=!1,this.headingLevel="3"}render(){return ew`
			<div class="section">
		...
		`}renderSummaryResult(){return!1===this._homeState.hasAnyIntegrationConnected?ew`<ul class="menu">
			...
			`:this.renderSummary(this._summaryState.state)}renderSummary(e){if(null==e)return e$;if("error"in e)return ew`<ul class="menu">
				...
				<li>(${e.total} other pull requests)</li>
						...
						</li>`)}}}return ew`<menu class="menu">${t}</menu>`}};li.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},li.styles=[rh,E`
			:host {
				display: block;
				margin-bottom: 2.4rem;
				color: var(--vscode-foreground);
		...
		`],lr([C({context:"state",subscribe:!0}),eL()],li.prototype,"_homeState",2),lr([C({context:"ipc"})],li.prototype,"_ipc",2),li=lr([eB("gl-launchpad")],li);let ln=(e,t,o)=>{let r=new Map;for(let i=t;i<=o;i++)r.set(e[i],i);return r},ls=tN(class extends directive_i{constructor(e){if(super(e),2!==e.type)throw Error("repeat() can only be used in text expressions")}dt(e,t,o){let r;void 0===o?o=t:void 0!==t&&(r=t);let i=[],n=[],a=0;for(let t of e)i[a]=r?r(t,a):a,n[a]=o(t,a),a++;return{values:n,keys:i}}render(e,t,o){return this.dt(e,t,o).values}update(e,[t,o,r]){let i=e._$AH,{values:n,keys:a}=this.dt(t,o,r);if(!Array.isArray(i))return this.ut=a,n;let l=this.ut??=[],c=[],d,h,p=0,u=i.length-1,g=0,m=n.length-1;for(;p<=u&&g<=m;)if(null===i[p])p++;else if(null===i[u])u--;else if(l[p]===a[g])c[g]=tq(i[p],n[g]),p++,g++;else if(l[u]===a[m])c[m]=tq(i[u],n[m]),u--,m--;else if(l[p]===a[m])c[m]=tq(i[p],n[m]),tF(e,c[m+1],i[p]),p++,m--;else if(l[u]===a[g])c[g]=tq(i[u],n[g]),tF(e,i[p],i[u]),u--,g++;else if(void 0===d&&(d=ln(a,g,m),h=ln(l,p,u)),d.has(l[p]))if(d.has(l[u])){let t=h.get(a[g]),o=void 0!==t?i[t]:null;if(null===o){let t=tF(e,i[p]);tq(t,n[g]),c[g]=t}else c[g]=tq(o,n[g]),tF(e,i[p],o),i[t]=null;g++}else tW(i[u]),u--;else tW(i[p]),p++;for(;g<=m;){let t=tF(e,c[m+1]);tq(t,n[g]),c[g++]=t}for(;p<=u;){let e=i[p++];null!==e&&tW(e)}return this.ut=a,((e,t=tU)=>e._$AH=t)(e,c),ek}}),la=E`
	:host {
...
`;var ll=Object.defineProperty,lc=Object.getOwnPropertyDescriptor,ld=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lc(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&ll(t,o,n),n};let lh=class extends GlElement{constructor(){super(),this.disabled=!1,this.value="",this._defaultChecked=!1,this.checked=!1,this._defaultChecked=this.checked}get defaultChecked(){return this._defaultChecked}handleChange(e){this.checked=e.target.checked;let t=new CustomEvent("gl-change-value");this.dispatchEvent(t)}renderCheck(){if(this.checked)return ew` <code-icon icon="check"></code-icon> `}render(){return ew`<label ?aria-disabled=${this.disabled}
		...
		</label>`}};lh.shadowRootOptions={...GlElement.shadowRootOptions,delegatesFocus:!0},lh.styles=[la],ld([eT({type:Boolean,reflect:!0})],lh.prototype,"disabled",2),ld([eT({type:String})],lh.prototype,"value",2),ld([eT({type:Boolean})],lh.prototype,"defaultChecked",1),ld([eT({type:Boolean,reflect:!0})],lh.prototype,"checked",2),lh=ld([eB("gl-checkbox")],lh);var lp=Object.defineProperty,lu=Object.getOwnPropertyDescriptor,lg=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lu(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lp(t,o,n),n};let lm=E`
	.select {
		background: none;
		outline: none;
		border: none;
...
`;let GlObjectSelect=class GlObjectSelect extends GlElement{constructor(){super(...arguments),this.disabled=!1}static{this.styles=[lm]}render(){if(this.options)return ew`
			<select .disabled=${this.disabled} class="select" @change=${e=>this.onChange?.(e)}>
				${ls(this.options,e=>{let t=this.getValue(e),o=this.getLabel(e);return ew`<option .value="${t}" ?selected=${this.value===t}>${o}</option>`})}
			</select>
		`}};lg([eT({type:Boolean})],GlObjectSelect.prototype,"disabled",2),lg([eT({type:String})],GlObjectSelect.prototype,"value",2),lg([eT({type:Array})],GlObjectSelect.prototype,"options",2);let lb=class extends GlObjectSelect{getValue(e){return e.value}getLabel(e){return e.label}onChange(e){let t=new CustomEvent("gl-change",{detail:{threshold:e.target.value}});this.dispatchEvent(t)}};lb=lg([eB("gl-branch-threshold-filter")],lb);var lf=Object.defineProperty,lv=Object.getOwnPropertyDescriptor,ly=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lv(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lf(t,o,n),n};let lw=class extends tD(lit_element_i){constructor(){super(...arguments),this.onChangeRecentThresholdFilter=e=>{this._inactiveOverviewState.filter.stale&&this._inactiveOverviewState.filter.recent&&this._ipc.sendCommand(e6,{stale:this._inactiveOverviewState.filter.stale,recent:{...this._inactiveOverviewState.filter.recent,threshold:e.detail.threshold}})}}connectedCallback(){super.connectedCallback?.(),this._homeState.repositories.openCount>0&&this._inactiveOverviewState.run()}render(){return this._homeState.discovering?this.renderLoader():0===this._homeState.repositories.openCount?e$:this._inactiveOverviewState.render({pending:()=>this.renderPending(),complete:e=>this.renderComplete(e),error:()=>ew`<span>Error</span>`})}renderLoader(){return ew`
			<gl-section>
				<skeleton-loader slot="heading" lines="1"></skeleton-loader>
				<skeleton-loader lines="3"></skeleton-loader>
			</gl-section>
		...
		`],ly([C({context:"state",subscribe:!0}),eL()],lw.prototype,"_homeState",2),ly([C({context:"inactiveOverviewState"})],lw.prototype,"_inactiveOverviewState",2),ly([C({context:"ipc"})],lw.prototype,"_ipc",2),lw=ly([eB("gl-overview")],lw);var l_=Object.defineProperty,lk=Object.getOwnPropertyDescriptor,l$=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lk(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&l_(t,o,n),n};let lx=class extends GlElement{constructor(){super(...arguments),this.badgeSource={source:"home",detail:"badge"}}get orgAllowsDrafts(){return this._state.orgSettings.drafts}get blockRepoFeatures(){if(!this._state)return!0;let{repositories:{openCount:e,hasUnsafe:t,trusted:o}}=this._state;return!o||0===e||t}onRepoFeatureClicked(e){return!this.blockRepoFeatures||(e.preventDefault(),e.stopPropagation(),!1)}render(){return ew`
		...
		`}};lx.styles=[o2,o8,o3,E``],l$([eT({type:Object})],lx.prototype,"badgeSource",2),l$([C({context:"state",subscribe:!0}),eL()],lx.prototype,"_state",2),lx=l$([eB("gl-feature-nav")],lx);let lC=E`
	:host {
...
`;var lS=Object.defineProperty,lP=Object.getOwnPropertyDescriptor,lO=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lP(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lS(t,o,n),n};let lA=class extends lit_element_i{constructor(){super(...arguments),this.display="solid"}get classNames(){return{banner:!0,[`banner--${this.display}`]:!0}}render(){return ew` <div part="base" class=${iX(this.classNames)}>${this.renderContent()}</div> `}renderContent(){return ew`
		...
		`}onPrimaryButtonClick(e){this.primaryButtonCommand&&e.preventDefault(),this.dispatchEvent(new CustomEvent("gl-banner-primary-click",{detail:{command:this.primaryButtonCommand},bubbles:!0,composed:!0}))}onSecondaryButtonClick(e){this.secondaryButtonCommand&&e.preventDefault(),this.dispatchEvent(new CustomEvent("gl-banner-secondary-click",{detail:{command:this.secondaryButtonCommand},bubbles:!0,composed:!0}))}};lA.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},lA.styles=[lC],lO([eT({reflect:!0})],lA.prototype,"display",2),lO([eT({attribute:"banner-title"})],lA.prototype,"bannerTitle",2),lO([eT()],lA.prototype,"body",2),lO([eT({attribute:"primary-button"})],lA.prototype,"primaryButton",2),lO([eT({attribute:"primary-button-href"})],lA.prototype,"primaryButtonHref",2),lO([eT({attribute:"primary-button-command"})],lA.prototype,"primaryButtonCommand",2),lO([eT({attribute:"secondary-button"})],lA.prototype,"secondaryButton",2),lO([eT({attribute:"secondary-button-href"})],lA.prototype,"secondaryButtonHref",2),lO([eT({attribute:"secondary-button-command"})],lA.prototype,"secondaryButtonCommand",2),lA=lO([eB("gl-banner")],lA);var lR=Object.defineProperty,lI=Object.getOwnPropertyDescriptor,lB=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lI(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lR(t,o,n),n};let lE=class extends lit_element_i{get shouldShow(){return!this._state.aiAllAccessBannerCollapsed}get bodyLabel(){return this.hasAdvancedOrHigher?"Opt in now to get unlimited GitKraken AI until July 11th!":"Opt in now to try all Advanced GitLens features with unlimited GitKraken AI for FREE until July 11th!"}get primaryButtonLabel(){return"Opt In Now"}get hasAdvancedOrHigher(){var e,t;return this._state.subscription.plan&&(e=this._state.subscription.plan.actual.id,rr(e)-rr("advanced")>=0)||(t=this._state.subscription.plan.effective.id,rr(t)-rr("advanced")>=0)}render(){return this.shouldShow?ew`
			<gl-banner
				display="gradient"
			...
			></gl-banner>
		`:e$}onSecondaryClick(){this._ipc.sendCommand(e8,void 0)}};lE.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},lE.styles=[E`
			:host {
				display: block;
			}
		...
		`],lB([C({context:"state",subscribe:!0}),eL()],lE.prototype,"_state",2),lB([C({context:"ipc",subscribe:!0}),eL()],lE.prototype,"_ipc",2),lE=lB([eB("gl-ai-all-access-banner")],lE);var lT=Object.defineProperty,lL=Object.getOwnPropertyDescriptor,lz=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lL(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lT(t,o,n),n};let lD=class extends lit_element_i{constructor(){super(...arguments),this.closed=!1}render(){return this.closed||!0===this._state.amaBannerCollapsed?e$:ew`
		...
		`}onClose(){this.closed=!0,this._state.amaBannerCollapsed=!0,this._ipc.sendCommand(e1,{section:"feb2025AmaBanner",collapsed:!0})}};lD.styles=[o2,E`
			:host {
		...
		`],lz([C({context:"state",subscribe:!0}),eL()],lD.prototype,"_state",2),lz([C({context:"ipc",subscribe:!0}),eL()],lD.prototype,"_ipc",2),lz([eL()],lD.prototype,"closed",2),lD=lz([eB("gl-ama-banner")],lD);var lN=Object.defineProperty,lM=Object.getOwnPropertyDescriptor,lj=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lM(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lN(t,o,n),n};let lF=class extends lit_element_i{constructor(){super(...arguments),this.closed=!1}render(){return this.closed||this._state.hasAnyIntegrationConnected||this._state.integrationBannerCollapsed?e$:ew`
			<gl-card>
		...
		`}onClose(){this.closed=!0,this._ipc.sendCommand(e1,{section:"integrationBanner",collapsed:!0})}focus(){this._button.focus()}};lF.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},lF.styles=[E`
			gl-card::part(base) {
				margin-block-end: 1.2rem;
			}
		`],lj([C({context:"state",subscribe:!0}),eL()],lF.prototype,"_state",2),lj([C({context:"ipc",subscribe:!0}),eL()],lF.prototype,"_ipc",2),lj([eL()],lF.prototype,"closed",2),lj([eD("gl-button")],lF.prototype,"_button",2),lF=lj([eB("gl-integration-banner")],lF);var lq=Object.defineProperty,lU=Object.getOwnPropertyDescriptor,lW=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lU(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lq(t,o,n),n};let lH=class extends lit_element_i{constructor(){super(...arguments),this.closed=!1}get isNewInstall(){return this._state.newInstall}render(){return!0!==this._state.previewEnabled?ew`
		...
		`}togglePreview(e=!1){this._ipc.sendCommand(e0),e&&(this.closed=!0)}onClose(){this.closed=!0,this._ipc.sendCommand(e1,{section:"newHomePreview",collapsed:!0})}focus(){this._button?.focus()}};lH.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},lH.styles=[o2,E`
			.title {
				margin-block-end: 0.4em;
			}
		...
		`],lW([C({context:"state",subscribe:!0}),eL()],lH.prototype,"_state",2),lW([C({context:"ipc",subscribe:!0}),eL()],lH.prototype,"_ipc",2),lW([eL()],lH.prototype,"closed",2),lW([eD("button")],lH.prototype,"_button",2),lH=lW([eB("gl-preview-banner")],lH);var lG=Object.defineProperty,lV=Object.getOwnPropertyDescriptor,lK=(e,t,o,r)=>{for(var i,n=r>1?void 0:r?lV(t,o):t,a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r?i(t,o,n):i(n))||n);return r&&n&&lG(t,o,n),n};let lY=class extends lit_element_i{render(){return ew`
			<gl-promo
		...
		`}refreshAiAllAccessPromo(){this.allAccessPromoBanner?.requestUpdate()}};l5.styles=[o8,o5,o6],l2([x({context:"activeOverviewState"})],l5.prototype,"_activeOverviewState",2),l2([x({context:"inactiveOverviewState"})],l5.prototype,"_inactiveOverviewState",2),l2([eD("gl-home-header")],l5.prototype,"_header",2),l2([eD("gl-ai-all-access-banner")],l5.prototype,"allAccessPromoBanner",2),l5=l2([eB("gl-home-app")],l5);export{l5 as GlHomeApp};