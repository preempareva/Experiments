...
[${il?"⌥":"Alt"}] ${this.altLabel}`:this.label}get effectiveLabel(){if(this.label||this.altLabel)return this.altLabel&&this.isAltKeyPressed?this.altLabel:this.label}get effectiveHref(){return this.isAltKeyPressed&&this.altHref?this.altHref:this.href}connectedCallback(){super.connectedCallback?.(),window.addEventListener("keydown",this),window.addEventListener("keyup",this)}disconnectedCallback(){super.disconnectedCallback?.(),window.removeEventListener("keydown",this),window.removeEventListener("keyup",this)}handleEvent(e){let t="Alt"===e.key||e.altKey;"keydown"===e.type?this.isAltKeyPressed=t:"keyup"===e.type&&t&&(this.isAltKeyPressed=!1)}render(){return tM`
	...
	`,od([tK()],oh.prototype,"href",2),od([tK({attribute:"alt-href"})],oh.prototype,"altHref",2),od([tK()],oh.prototype,"label",2),od([tK({attribute:"alt-label"})],oh.prototype,"altLabel",2),od([tK()],oh.prototype,"icon",2),od([tK({attribute:"alt-icon"})],oh.prototype,"altIcon",2),od([tK({type:Boolean})],oh.prototype,"disabled",2),od([tQ("a")],oh.prototype,"defaultFocusEl",2),od([tZ()],oh.prototype,"isAltKeyPressed",2),oh=od([tW("action-item")],oh);let op={".":"Unchanged","!":"Ignored","?":"Untracked",A:"Added",D:"Deleted",M:"Modified",R:"Renamed",C:"Copied",AA:"Conflict",AU:"Conflict",UA:"Conflict",DD:"Conflict",DU:"Conflict",UD:"Conflict",UU:"Conflict",T:"Modified",U:"Updated but Unmerged"};var ou=Object.defineProperty,og=Object.getOwnPropertyDescriptor,of=(e,t,r,o)=>{for(var n,a=o>1?void 0:o?og(t,r):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(o?n(t,r,a):n(a))||a);return o&&a&&ou(t,r,a),a};let om=class extends lit_element_i{get statusName(){return this.status?op[this.status]??"Unknown":""}updated(e){super.updated(e),e.has("status")&&(this.statusName?this.setAttribute("title",this.statusName):this.removeAttribute("title"))}renderIgnored(){return tM`
...
`;var oH=Object.defineProperty,oF=Object.getOwnPropertyDescriptor;let oq=class extends lit_element_i{render(){return tM`<slot class="badge" part="base"></slot>`}};oq.styles=[oj],oq=((e,t,r,o)=>{for(var n,a=o>1?void 0:o?oF(t,r):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(o?n(t,r,a):n(a))||a);return o&&a&&oH(t,r,a),a})([tW("gl-badge")],oq);var oV=Object.defineProperty,oW=Object.getOwnPropertyDescriptor,oG=(e,t,r,o)=>{for(var n,a=o>1?void 0:o?oW(t,r):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(o?n(t,r,a):n(a))||a);return o&&a&&oV(t,r,a),a};let oK=class extends lit_element_i{constructor(){super(...arguments),this.editor=!1,this.layout="shift",this.grouping="gap"}render(){return tM`<div class="group"><slot></slot></div>`}};oK.styles=[ob,e4`
			:host {
...
`;var se=Object.defineProperty,si=Object.getOwnPropertyDescriptor,sr=(e,t,r,o)=>{for(var n,a=o>1?void 0:o?si(t,r):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(o?n(t,r,a):n(a))||a);return o&&a&&se(t,r,a),a};let so=class extends lit_element_i{constructor(){super(...arguments),this.markdown="",this.density="compact"}render(){return tM`${this.markdown?o9(this.renderMarkdown(this.markdown),"Loading..."):""}`}async renderMarkdown(e){n8.setOptions({gfm:!0}),n8.use({renderer:{image:function({href:e,title:t,text:r}){let o=[],n=[];return e&&({href:e,dimensions:o}=function(e){let t=[],r=e.split("|").map(e=>e.trim());e=r[0];let o=r[1];if(o){let e=/height=(\d+)/.exec(o),r=/width=(\d+)/.exec(o),n=e?e[1]:"",a=r?r[1]:"",c=isFinite(parseInt(a)),d=isFinite(parseInt(n));c&&t.push(`width="${a}"`),d&&t.push(`height="${n}"`)}return{href:e,dimensions:t}}(e),n.push(`src="${sh(e)}"`)),r&&n.push(`alt="${sh(r)}"`),t&&n.push(`title="${sh(t)}"`),o.length&&(n=n.concat(o)),`<img ${n.join(" ")}>`},paragraph:function({tokens:e}){let t=this.parser.parseInline(e);return`<p>${t}</p>`},link:function({href:e,title:t,tokens:r}){if("string"!=typeof e)return"";let o=this.parser.parseInline(r);return e===o&&(o=sp(o)),t="string"==typeof t?sh(sp(t)):"",e=sp(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),`<a href="${e}" title="${t||e}" draggable="false">${o}</a>`},code:function({text:e,lang:t}){return e=e.replace(/</g,"&lt;"),`<pre class="language-${t}"><code>${e}</code></pre>`},codespan:function({text:e}){return e=e.replace(/</g,"&lt;"),`<code>${e}</code>`}}});let t=await n8.parse(e.replace(sc,e=>`\\${e}`));return ii(t=function(e){let t,r=[],o=0,n=0;for(;null!==(t=sd.exec(e));){o<(n=t.index||0)&&r.push(e.substring(o,n)),o=(t.index||0)+t[0].length;let[,a,c]=t;r.push(a?`$(${c})`:function(e){let[,t,r]=sa.exec(e.id)??[void 0,"error",void 0];return t.startsWith("gitlens-")&&(t=`gl-${t.substring(8)}`),`<code-icon icon="${t}"${r?` modifier="${r}"`:""}></code-icon>`}({id:c}))}return o<e.length&&r.push(e.substring(o)),r.join("")}(t))}};so.styles=[n4,e4`
		...
		`],sr([tK({type:String})],so.prototype,"markdown",2),sr([tK({type:String,reflect:!0})],so.prototype,"density",2),so=sr([tW("gl-markdown")],so);let sn="[A-Za-z0-9-]+",ss="~[A-Za-z]+",sa=RegExp(`^(${sn})(${ss})?$`),sl=RegExp(`\\$\\(${sn}(?:${ss})?\\)`,"g"),sc=RegExp(`\\\\${sl.source}`,"g"),sd=RegExp(`(\\\\)?\\$\\((${sn}(?:${ss})?)\\)`,"g");function sh(e){return e.replace(/"/g,"&quot;")}function sp(e){return e?e.replace(/\\([\\`*_{}[\]()#+\-.!~])/g,"$1"):e}var su=Object.defineProperty,sg=Object.getOwnPropertyDescriptor,sf=(e,t,r,o)=>{for(var n,a=o>1?void 0:o?sg(t,r):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(o?n(t,r,a):n(a))||a);return o&&a&&su(t,r,a),a};let sm=class extends lit_element_i{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return tM`<div class="progress-bar"></div>`}};sm.styles=e4`
		* {
			box-sizing: border-box;
		}
	...
	`,sf([tK({reflect:!0})],sm.prototype,"mode",2),sf([tK({type:Boolean})],sm.prototype,"active",2),sf([tK()],sm.prototype,"position",2),sm=sf([tW("progress-indicator")],sm);var sb=Object.defineProperty,sv=Object.getOwnPropertyDescriptor,sy=(e,t,r,o)=>{for(var n,a=o>1?void 0:o?sv(t,r):t,c=e.length-1;c>=0;c--)(n=e[c])&&(a=(o?n(t,r,a):n(a))||a);return o&&a&&sb(t,r,a),a};let sw=class extends lit_element_i{constructor(){super(...arguments),this.collapsable=!1,this.expanded=!1,this.loading=!1}renderTitle(){return this.collapsable?tM`<button
			type="button"
			class="label"
